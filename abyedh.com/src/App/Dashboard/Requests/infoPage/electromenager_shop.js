                    ...
                    <div className="table-responsive">
                        <table className="table table-striped text-nowrap">
                            <tbody>
                                ...
                                <tr>
                                    <td className='col-5 text-secondary'><span className='bi bi-cash-coin me-2'></span> Paymment </td>
                                    <td>{loading ? requestData.Paymment_Mode : ''}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td className='col-5 text-secondary'><span className='bi bi-chat-dots-fill me-2'></span> Commentaires </td>
