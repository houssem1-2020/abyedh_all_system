...
function DocteurSpecific() {
   ...
   /*#########################[Function]##################################*/
    ...
    const TarifListeCard = (props) =>{
        return(<>
            {returnedProfileData.SP_Articles == '' ? 
            <ListeVide icon='star-fill' /> 
            :
            <>
              ...
              <br />
              <Button    fluid className='rounded-pill' size='tiny' color='blue' onClick={() => UpdateFunction('SP_Articles')}>  <Icon name='plus' className='ms-2' /> Modifier </Button>
            </> 
            } 
        </>)
    }
    ...
    const AssuranceListeCard = (props) =>{
          return(<>
            {returnedProfileData.SP_Genres == '' ? 
            <ListeVide icon='bookmarks-fill' /> 
            :
            <>
              <div style={{maxHeight:'300px', overflowX:'auto', overflowX:'hidden'}}  >
              ...
              <br />
              <Button    fluid className='rounded-pill' size='tiny' color='blue' onClick={() => UpdateFunction('SP_Genres')}>  <Icon name='plus' className='ms-2' /> Modifier </Button>
            </> 
            } 
        </>)
    }
    ...
    const DiplomeListeCard = (props) =>{
        return(<>
          {returnedProfileData.SP_Promotion == '' ? 
          <ListeVide icon='megaphone' /> 
          :
          <>
            <div style={{maxHeight:'300px', overflowX:'auto', overflowX:'hidden'}}  >
            ...
            <br />
            <Button    fluid className='rounded-pill' size='tiny' color='blue' onClick={() => UpdateFunction('SP_Promotion')}>  <Icon name='plus' className='ms-2' /> Modifier </Button>
          </> 
          } 
      </>)
    }
    ...
    return (<>
          ...
          <div className='row mb-3'>
              <div className='col-10 align-self-center'><h4>Liste des Articles : </h4></div>
          ...
          <br />
          <div className='row mb-3'>
              <div className='col-10 align-self-center'><h4>  Genes des Articles  : </h4></div>
          ...
          <br />
          <div className='row mb-3'>
              <div className='col-10 align-self-center'><h4>  Promotion  : </h4></div>
