...
function DocteurSpecific() {
   ...
   /*#########################[Function]##################################*/
    ...
    return (<>
          ...
          <br />
          <div className='row mb-3'>
              <div className='col-10 align-self-center'><h4 style={{color : APPConf.landing[APPConf.systemTag].colorTheme}}> <span className='bi bi-bookmarks-fill'></span>  Familles  : </h4></div>
