...
function ComptableSpecific() {
    ...
    const panes = [
        ...
        {
            menuItem: { key: 'edit', icon: 'pin', content:  <span className='me-2'>إستشارات </span> , dir:'rtl' },
            render: () => <TableGrid tableData={seanceListe}  columns={['فتح','عدد','يوم','معرف']} />,
        },
        {
            menuItem: { key: 'oug', icon: 'list alternate outline', content:  <span className='me-2'>تقارير</span> , dir:'rtl' },
