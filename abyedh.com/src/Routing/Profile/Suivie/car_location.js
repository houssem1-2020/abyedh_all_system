    ...
    const NextRendyVous = () =>{
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                <h5 className='text-end text-secondary'>  فترة الإنتهاء </h5> 
        ...
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                ...
                <div className='row' dir='rtl'>
                    ...
                    <div className='col-6 border-start'><h2 style={{color:GConf.ADIL[tag].themeColor}}>{rendyVousD.length} </h2> طلب </div>
                    <div className='col-6 '><h2 style={{color:GConf.ADIL[tag].themeColor}}>{seanceListe.length} </h2> فاتورة </div>
                </div>
            </div>
        </>)
    }
