...
function SmasarSpecific() {
    ...
    const panes = [
        ...
        {
            menuItem: { key: 'edit', icon: 'pin', content:  <span className='me-2'>منازل</span> , dir:'rtl' },
    ...
    const NextRendyVous = () =>{
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                <h5 className='text-end text-secondary'> آخر عملية كراء  </h5> 
        ...
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                ...
                <div className='row' dir='rtl'>
                    ...
                    <div className='col-4 border-start'><h2 style={{color:GConf.ADIL[tag].themeColor}}>{rendyVousD.length} </h2> منزل</div>
                    <div className='col-4 '><h2 style={{color:GConf.ADIL[tag].themeColor}}>{seanceListe.length} </h2> عقد</div>
                </div>
            </div>
        </>)
    }
