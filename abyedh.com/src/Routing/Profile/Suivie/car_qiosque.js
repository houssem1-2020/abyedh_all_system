...
function CarQiosqieSpecific() {
    ...
    const panes = [
        ...
        {
            menuItem: { key: 'edit', icon: 'pin', content:  <span className='me-2'>غسيل</span> , dir:'rtl' },
    ...
    const GetTheLastRDV = (dateList) =>{
        if (dateList.length === 0) {
            return <h1 className='display-1' style={{color: GConf.ADIL[tag].themeColor}}><span className='bi bi-calendar2-event bi-lg'></span></h1>;
          }
    ...
    const NextRendyVous = () =>{
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                <h5 className='text-end text-secondary'>  أخر موعد غسيل </h5> 
        ...
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                ...
                <div className='row' dir='rtl'>
                    ...
                    <div className='col-4 border-start'><h2 style={{color:GConf.ADIL[tag].themeColor}}>{rendyVousD.length} </h2> غسيل </div>
