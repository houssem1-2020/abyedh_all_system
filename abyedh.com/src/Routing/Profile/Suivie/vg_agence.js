...
function VgAgenceSpecific() {
    ...
    const panes = [
        ...
        {
            menuItem: { key: 'edit', icon: 'pin', content:  <span className='me-2'>رحلات</span> , dir:'rtl' },
            render: () => <TableGrid tableData={seanceListe}  columns={['فتح','عدد','يوم','معرف']} />,
        },
        {
            menuItem: { key: 'oug', icon: 'list alternate outline', content:  <span className='me-2'>ملفات</span> , dir:'rtl' },
    ...
    const NextRendyVous = () =>{
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                <h5 className='text-end text-secondary'> الرحلة القادمة </h5> 
        ...
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                ...
                <div className='row' dir='rtl'>
                    ...
                    <div className='col-4 border-start'><h2 style={{color:GConf.ADIL[tag].themeColor}}>{rendyVousD.length} </h2> رحلة</div>
                    <div className='col-4 '><h2 style={{color:GConf.ADIL[tag].themeColor}}>{seanceListe.length} </h2> ملف</div>
                </div>
            </div>
        </>)
    }
