...
function AvocatSpecific() {
    ...
    const panes = [
        {
          menuItem: { key: 'save', icon: 'calendar alternate', content:  <span className='me-2'> قضايا </span> , dir:'rtl' },
          render: () => <TableGrid tableData={rendyVousD}  columns={['فتح','عدد','يوم','يوم']} />,
        },
        {
            menuItem: { key: 'oug', icon: 'list alternate outline', content:  <span className='me-2'>مواعيد</span> , dir:'rtl' },
        ...
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                ...
                <div className='row' dir='rtl'>
                    <div className='col-4 border-start'><h2 style={{color:GConf.ADIL[tag].themeColor}}>{ordonanceListe.length} </h2>  قضية </div>
