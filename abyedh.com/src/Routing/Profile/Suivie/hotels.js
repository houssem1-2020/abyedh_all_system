...
function HotelsSpecific() {
    ...
    const panes = [
        ...
        {
            menuItem: { key: 'oug', icon: 'list alternate outline', content:  <span className='me-2'>خدمات</span> , dir:'rtl' },
    ...
    const NextRendyVous = () =>{
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                <h5 className='text-end text-secondary'> باقي علي تسلم الخدمة  </h5> 
        ...
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                ...
                <div className='row' dir='rtl'>
                    ...
                    <div className='col-4 '><h2 style={{color:GConf.ADIL[tag].themeColor}}>{seanceListe.length} </h2> خدمة </div>
                </div>
            </div>
        </>)
    }
