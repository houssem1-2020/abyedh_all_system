...
function AdminFPosteSpecific() {
    ...
    const RoleTimeEstimateCard = () =>{
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                <h5 className='text-end ' style={{color: GConf.ADIL[tag].themeColor}}>    عدد النوافذ الشاغرة </h5> 
                <h1 className='display-1' style={{color: GConf.ADIL[tag].themeColor}}><span className='bi bi-window-dock bi-lg'></span></h1>
            </div>
        </>)
    }
    const TarifCard = () =>{
...
export default AdminFPosteSpecific;