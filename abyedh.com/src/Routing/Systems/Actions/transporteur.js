        ...
        <div className='m-0'>
                <div   dir='rtl' className='card card-body shadow-sm pt-5 border-div'>
                    <div class="input-group mb-1">
                        <input type="text" class="form-control" id="request-type" dir="rtl" required placeholder="نوع البضاعة " />
                    </div>
                    <div class="input-group mb-1">
                        <input type="text" class="form-control" id="request-poid" dir="rtl" required placeholder="الوزن التقريبي" />
                    </div>
                    <div class="input-group mb-1">
                        <textarea type="text" class="form-control"  rows="4" id="request-comment" dir="rtl" required placeholder="وصف البضاعة + ملاحضات إضافية"></textarea>
                    </div>
                    <div class="text-right text-danger mb-1 mr-2"><span>تاريخ التوصيل</span></div>
                    <div class="input-group mb-3 float-right">
                        <input type="date" class="form-control" id="request-date" value="<?php echo date('Y-m-d'); ?>" min="2019-01-01" max="2020-12-29" />
                    </div>
