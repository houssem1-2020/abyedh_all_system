...
const CommandeCard = ({commandeData, setCommandeD, SaveCMDFunc , disabledSaveBtn, tag, loaderState}) =>{       
    return(<>
        ...
        <input type="text" class="form-control" id="request-genre" dir="rtl" required placeholder="نوع الوقود" />
        </div>
        <div class="input-group mb-1">
            <input type="text" class="form-control" id="request-quantite" dir="rtl" required placeholder="الكمية" />
        </div>
        <div class="input-group mb-1">
            <textarea type="text" class="form-control"  rows="2" id="request-comment" dir="rtl" required placeholder="ملاحضات"></textarea>
        </div>
        <input type="hidden" value="<?php echo $PID; ?>" id="request-pid" />
        <div class="text-left">
            <button class="btn btn-success card-1 btn-sm" id="request" >تأكيد <span class="fa fa-check-circle"></span></button>
...
const RendyVousCard = ({rendyVousD, setRdvData, RendyVousFunc, disabledSaveBtn, tag, loaderState }) =>{
    return(<>
            <div class="input-group mb-1">
                <input type="text" class="form-control" id="lavage-name" dir="rtl" required placeholder="الاسم و اللقب" />
            </div>
            <div class="input-group mb-1">
                <input type="text" class="form-control" id="lavage-genre" dir="rtl" required placeholder="نوع السيارة " />
            </div>
            <div class="text-right text-danger mb-1 mr-2"><span>التاريخ</span></div>
            <div class="input-group mb-3 float-right">
                <input type="date" class="form-control" id="lavage-jour" value="<?php echo date('Y-m-d'); ?>" min="2019-01-01" max="2020-12-29" />
                <input type="time" class="form-control" id="lavage-heur" value="<?php echo date('H:i'); ?>" />
            </div>
            <div class="input-group mb-3">
                <textarea type="text" class="form-control"  rows="2" id="lavage-comment" dir="rtl" required placeholder="ملاحضات"></textarea>
            </div>
            <input type="hidden" value="<?php echo $PID; ?>" id="lavage-pid" />
            <div class="text-left">
                <button class="btn btn-success card-1 btn-sm" id="lavage" >تأكيد <span class="fa fa-check-circle"></span></button>
