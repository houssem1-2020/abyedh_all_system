...
function SanteDocumment() {
    ...
    const ActivePaneCard = (props) =>{
        return(<>
            <div className={`card p-2 btn-cursor mb-1  text-center    border-div ${ activeIndex == props.activeI ? 'border-2 border-danger ': '' }`} onClick={ () => setActiveIndex(props.activeI)}>
                    <h2 className='text-center mb-0'  ><img src={`https://cdn.abyedh.com/images/Profile/documments/education/${props.icon}`} width='40px'  height='40px' /></h2> 
    ...
    return ( <>
            <div className=' d-flex pb-4' dir={isRTL ? 'rtl' : 'ltr'} style ={{overflowX : 'auto', overflowY : 'hidden', paddingBottom:'5px'} }>
                    ...
                    <div className='col-4 col-lg-3 ms-2'><ActivePaneCard text='بطاقة دخول ' icon='ticket.png' activeI={3} /> </div>                
            </div>
