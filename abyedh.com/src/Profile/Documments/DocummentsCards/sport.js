...
function SanteDocumment() {
    ...
    return ( <>
            <div className=' d-flex pb-4' dir='rtl' style ={{overflowX : 'auto', overflowY : 'hidden', paddingBottom:'5px'} }>
                    <div className='col-4 col-lg-3 ms-2'><ActivePaneCard text='إشتراكات ' icon='ordonnace.png' activeI={0} /> </div>
                    <div className='col-4 col-lg-3 ms-2'><ActivePaneCard text='حصص' icon='rendyVous.png' activeI={1} /> </div>
                    <div className='col-4 col-lg-3 ms-2'><ActivePaneCard text='حجوزات' icon='seance.png' activeI={2} /> </div>                
