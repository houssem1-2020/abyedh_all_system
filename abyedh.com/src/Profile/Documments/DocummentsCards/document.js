...
function SanteDocumment() {
    ...
    return ( <>
            <div className=' d-flex pb-4' dir='rtl' style ={{overflowX : 'auto', overflowY : 'hidden', paddingBottom:'5px'} }>
                    <div className='col-4 col-lg-3 ms-2'><ActivePaneCard text='بطاقة تعريف' icon='ordonnace.png' activeI={0} /> </div>
                    <div className='col-4 col-lg-3 ms-2'><ActivePaneCard text='جواز سفر' icon='rendyVous.png' activeI={1} /> </div>
                    <div className='col-4 col-lg-3 ms-2'><ActivePaneCard text='رخضة قيادة' icon='seance.png' activeI={2} /> </div>                
                    <div className='col-4 col-lg-3 ms-2'><ActivePaneCard text='بطاقة بنكية' icon='analyse.png' activeI={3} /> </div>                
                    <div className='col-4 col-lg-3 ms-2'><ActivePaneCard text='حساب بنكي' icon='analyse.png' activeI={4} /> </div>                
                    <div className='col-4 col-lg-3 ms-2'><ActivePaneCard text='دفتر إدخار' icon='analyse.png' activeI={5} /> </div>                
            </div>
