...
function HandmadeForferonSpecific(props) {
    /* ############### Const #################*/
    ...
    return ( <>
        <div className='m-0'>
                <div   dir='rtl' className='card card-body shadow-sm pt-3 border-div'>
                    ...
                    <smal>  ماذا تريد أن تصنع بالحديد و مشتقاته </smal>
                    ...
                    <Form className='mb-3'>
                        <TextArea placeholder='إذكر نوعية المعدن المطلوب' className='font-droid'  rows={3} value={rendyVousD.comment} onChange={ (e,value) => setRdvData({...rendyVousD, comment:e.target.value})} />
                    </Form>
...
export default HandmadeForferonSpecific;