...
function HandmadeElectricienSpecific(props) {
    /* ############### Const #################*/
    ...
    const stayOptions = [
        { key: '1', value: 'تركيب', text: 'تركيب  '  },
        { key: '2', value: 'صيانة', text: 'صيانة '  },
    ...
    return ( <>
        <div className='m-0'>
                <div   dir='rtl' className='card card-body shadow-sm pt-3 border-div'>
                    <h5 className='mb-0 mt-3' style={{color: GConf.ADIL[props.TAG].themeColor}}> <span className='bi bi-person-x-fill'></span> الخدمة المطلوبة</h5>
                    <smal>حدد الخدمة المطلوبة من الكهربائي </smal>
                    ...
                    <Form className='mb-3'>
                        <TextArea placeholder='ملاحضات' className='font-droid'  rows={3} value={rendyVousD.comment} onChange={ (e,value) => setRdvData({...rendyVousD, comment:e.target.value})} />
                    </Form>
...
export default HandmadeElectricienSpecific;