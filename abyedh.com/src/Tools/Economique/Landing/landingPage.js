...
function BlogLandingPage() {
    ...
    const BlogCard = (props)=>{
        ...
        <div className='col-12 col-lg-4'>
                <NavLink exact='true' to={`/tools/Sport/page/${props.data.Blog_ID}`} className="navbar-brand border-div m-0 p-0 ms-3">
                    <div className='card card-body shadow-sm mb-2 border-div text-center '>
                        <img src={`https://cdn.abyedh.com/images/Tools/Sport/${props.data.Img_Url}`} className='text-center' width={'70%'} height={'150px'} /> 
