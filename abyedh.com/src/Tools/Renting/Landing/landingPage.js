...
function BlogLandingPage() {
    ...
    useEffect(() => {
        window.scrollTo(0, 0);
        GetLocaliteList()
        axios.post(`${GConf.ApiToolsLink}/renting`, {
            genre:genre,
            gouv:gouv,
            deleg :deleg
          })
    ...
    const ButtomCard = () =>{
        return(<>
            <div className='card-body rounded-bottom-card footer-abyedh' style={{backgroundColor: '#dc3545'}}>
        ...
        return (<>
                <div className='col-12 col-lg-4 mb-3'>
                    <div className='card shadow-sm h-100 border-div'>
                        <NavLink exact='true' to={`/Tools/Renting/profile/${props.data.PID}`} className='stretched-link'></NavLink>
                        <div className="card-header  " style={{marginBottom:'50px', height:'90px',  borderRadius:'0', background: `linear-gradient(to bottom, ${ConverColorToHsl(GConf.Tools.Renting.themeColor)},  #ffffff` , border: '0px solid' ,}}> 
                            <span
                                style={{
                                width: '100px',
                                height: '100px',
                            ...
                            >
                                <img src={`https://cdn.abyedh.com/images/Tools/rent_house.svg`} className='img-responsive rounded-circle bg-white' width='100px'  height='100px' />
                            </span>
                            
                        </div>
                        <div className='text-center '> <h5 style={{ color: GConf.Tools.Renting.themeColor}}>{props.data.Name} { props.data.Activated == 'YES' ?  <span className='bi bi-shield-fill-check text-dark'></span> : ''}</h5></div>
                        <div className='card-body text-secondary ' >
                            <div className='text-end  pb-2' dir='ltr'>
                            <div className='text-end' style={{marginRight:'20px'}} dir='rtl'> <span className='bi bi-geo-alt-fill' style={{color: GConf.Tools.Renting.themeColor}}></span> : {props.data.Gouv}</div> 
                            <div className='text-end' style={{marginRight:'20px'}} dir='rtl'> <span className='bi bi-geo-alt' style={{color: GConf.Tools.Renting.themeColor}}></span> : {props.data.Deleg}</div> 
                            <div className='text-end' style={{marginRight:'20px'}} dir='rtl'> <span className='bi bi-pin-map-fill' style={{color: GConf.Tools.Renting.themeColor}}></span> : {props.data.Adress}</div> 
                            </div>
                        </div>
                    </div>
    ...
    const ResultEmpty = () =>{
        return(<>
            <div className='card-body mb-4 ' dir='rtl'>
                ...
                <h3>عذرا , لا توجد عقارات حاليا لأحد الأسباب التالية :</h3> 
                <ul >
