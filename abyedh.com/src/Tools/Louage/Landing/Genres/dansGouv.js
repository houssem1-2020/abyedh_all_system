        ...
        <div className="row">
            <div className="col-12 col-lg-12 ">
                <div className='card card-body border-div shadow-sm mb-4'>
                    <h6 className='mb-1 text-end'> إختر ولاية <span className='bi bi-person-x-fill'></span> </h6>
                    <Input list='languages' dir='ltr' className='mb-2' fluid options={GConf.abyedhMap.Gouv} onChange={(e, { value }) => setTargetTripData({...targetTrip, depart: value })} />
