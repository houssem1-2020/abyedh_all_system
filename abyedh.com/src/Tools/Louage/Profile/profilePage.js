...
function BlogProfilePage() {
        ...
        const TopNavBar = () =>{
            ...
            return(<>
                    <nav className="p-2 fixed-top navshad" style={{backgroundColor: GConf.Tools.Louage.themeColor}}>
                        <div className='row'>
                            <div className='col-6 text-start align-self-center'>
                                <NavLink exact='true' to='/Tools/Louage' className="m-0 p-0 ms-3">
        ...
        return ( <>
            ...
            <div className='container' >
                <Link exaxt='true' to='/tools/Louage'><Button className='rounded-circle' icon='arrow left' /></Link>
                <br />
                <br />
                {
                    loading ? 
