...
function BlogPage() {
        ...
        <div className='card-body rounded-0' style={{height:'170px', backgroundColor:'white', marginTop:'55px'}}>
            <div className='row'>
                <div className='col-12 col-lg-8 align-self-center text-center'>
                       <h3  dir='rtl' style={{color:GConf.Tools.ProgramScolair.themeColor}}> {GConf.Tools.ProgramScolair.textAds} </h3>
                </div>
                <div className='col-4 align-self-end text-center d-none d-lg-block'>
                    <img src='https://cdn.abyedh.com/images/Tools/news.svg' className='img-responsive' width='40%' height='40%'  />
                </div>
            </div> 
        </div>
        </>)
                ...
                <div className='card card-body shadow-sm mb-3 border-div'>
                    <div className='row'>
                        <div className='col-3 align-self-center'>
                             <div className="icon-shape text-white rounded-circle elevation" style={{backgroundColor: GConf.Tools.ProgramScolair.themeColor, width: `${props.data.size}rem`, height: `${props.data.size}rem`}} >
    ...
    return ( <>
        ...
        <div className='container' dir='rtl'>
            <SearchBarCard />
            <div className='row'>
                <div className='col-12 col-md-6'><LinkCard data={Items[0]} level={0} text='رياض الأطفال و الكتاب' /></div>
                ...
                <div className='col-12 col-md-6'><LinkCard data={Items[4]} level={4} text='التعليم الجامعي'/></div>
            </div>
        </div>
        <br />
        <br />
