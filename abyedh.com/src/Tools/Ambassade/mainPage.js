...
function BlogPage() {
        ...
        <div className='card-body rounded-0' style={{height:'170px', backgroundColor:'white', marginTop:'55px'}}>
            <div className='row'>
                <div className='col-12 col-lg-8 align-self-center text-center'>
                       <h3  dir='rtl' style={{color:GConf.Tools.ambassade.themeColor}}> {GConf.Tools.ambassade.textAds} </h3>
                </div>
                <div className='col-4 align-self-end text-center d-none d-lg-block'>
                    <img src='https://cdn.abyedh.com/images/Tools/ambassade.svg' className='img-responsive' width='40%' height='40%'  />
                </div>
            </div> 
        </div>
        </>)
    ...
    return ( <>
        ...
        <AdsLanding /> 
        <br />
        <div className='container d-none' dir='rtl'>
            <SearchBarCard />
        ...
        <div className='container' style={{height:'430px'}}>
            <img src='https://cdn.abyedh.com/Images/Tools/worldMap.svg' className='img-responsive' width='100%' height='auto' />
        </div>
        <ButtomCard /> 
    </> );
}
