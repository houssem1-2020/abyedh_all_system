...
function BlogPage() {
        ...
        <div className='card-body rounded-0' style={{height:'170px', backgroundColor:'white', marginTop:'55px'}}>
            <div className='row'>
                ...
                <div className='col-4 align-self-end text-center d-none d-lg-block'>
                    <img src='https://cdn.abyedh.tn/images/Tools/ambassade.svg' className='img-responsive' width='40%' height='40%'  />
                </div>
            </div> 
        </div>
        </>)
    ...
    return ( <>
        ...
        <div className='container' style={{height:'430px'}}>
            <img src='https://cdn.abyedh.tn/Images/Tools/worldMap.svg' className='img-responsive' width='100%' height='auto' />
        </div>
        <ButtomCard /> 
    </> );
}
