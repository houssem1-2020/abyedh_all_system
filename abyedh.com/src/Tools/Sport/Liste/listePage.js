                ...
                <div className='col-6 col-lg-2 mb-3 '>
                    <NavLink exact='true' to={`/tools/Products/profile/${genre}/${tag}/${props.data.PK}`} className="   ">
                        <div className='card card-body shadow-sm  border-div text-center h-100'>
                            <div className='text-center'><img src={`https://cdn.abyedh.com/images/Tools/${SubCat[genre].subCategories.find(item => item.name === tag).image}`} className='text-center' width={'50px'} height={'50px'} /></div> 
