...
function BlogPage() {
    /* ###########################[const]############################ */
    const Items = [
        {id:1, size:4 , link:'sante',  icon:'capsule-pill',  iconColor:'#d91a33', text:'الدستور', smallText:'بطاقة علاج , جواز صحي, وصفة طبية , ...'},
        {id:1, size:4 , link:'transport',  icon:'mortarboard',  iconColor:'#d91a33', text:'المعاهدات الدولية', smallText:'رخصة سياقة , البطاقة الرمادية ...'},
        {id:1, size:4 , link:'finance',  icon:'car-front-fill',  iconColor:'#d91a33', text:'القوانين الأساسية', smallText:'البريد , البنوك التونسية ...'},
        {id:1, size:4 , link:'droit',  icon:'gift-fill',  iconColor:'#d91a33', text:' القوانين العادية ', smallText:'أنواع المحاكم , مجلات قانونية ...'},
        {id:1, size:4 , link:'religious',  icon:'cart4',  iconColor:'#d91a33', text:'اللوائح', smallText:'التسجيل للحج , رخصة بناء جامع ...'},
    ]
        ...
        <div className='card-body rounded-0' style={{height:'170px', backgroundColor:'#e9ecef', marginTop:'55px'}}>
            <div className='row'>
                ...
                <div className='col-4 align-self-end text-center d-none d-lg-block'>
                    <img src='https://cdn.abyedh.com/images/Tools/sport.svg' className='img-responsive' width='40%' height='40%'  />
                </div>
            </div> 
        </div>
        </>)
