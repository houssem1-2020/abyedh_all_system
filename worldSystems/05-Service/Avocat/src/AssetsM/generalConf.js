...
const GConf = {
    ...
    // main variables
    PID: GetPID(),
    ApiLink : 'https://api.abyedh.com/api/systems/avocat', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    ApiRouterOneLink : 'https://api.abyedh.com/api/systems/avocat-caisse', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    ApiRouterTwoLink : 'https://api.abyedh.com/api/systems/avocat-serveur', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    ApiRouterThreeLink : 'https://api.abyedh.com/api/systems/avocat-chef', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    ...
    NavsData : [
            ...
            {id:4, name:"Sujet", icon:"receipt-cutoff", link:"sj"},
            {id:3, name:"Client", icon:"people", link:"cl"},
            {id:6, name:"Seance", icon:"pc-display-horizontal", link:"sa"},
            // {id:5, name:"Calendrier", icon:"pc-display-horizontal", link:"cd"},
            {id:5, name:"Rapport", icon:"file-earmark-medical", link:"rp"},
    ...
    SubNavs: {
        ...
        seance: [
            {id:1,  icon: 'bookmark-plus', text: 'Nouveaux Seance', link: 'ajouter', dropD: false},
            // {id:2, icon: 'tags', text: 'Genres des Rapport', link: 'famille', dropD: false },
            // {id:3, icon: 'box-arrow-in-up', text: 'Bond entre', link: 'be', dropD: false },
            // {id:4, icon: 'box-arrow-up', text: 'Bond Sortie', link: 'bs', dropD: false },
        ],
        ...
        sujets: [
            {id:1,  icon: 'receipt', text: 'Nouveaux Sujet', link: 'ajouter', dropD: false},
    ...
    //TableHead
    TableHead:{
        sujets:['*','ID','Client','Titre','Date','Trubinal','Phase','Etat','Voir'],
        ...
        client:['*','Nom','CIN/Mat', 'Tel', 'Location','Adresse','Voir'],
