    ...
    useEffect(() => {
        ...
        .then(function (response) {
            if(!response.data) {
                ...
                setTimeout(() => {  window.location.href = "/S/sj"; }, 2000)
                
            } else {
                setSujetData(response.data)
                const contentBlocks = convertFromHTML(response.data.SJ_Description);
