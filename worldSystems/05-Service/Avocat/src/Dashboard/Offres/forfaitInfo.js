...
function ArticleInfo() {
   ...
   /*#########################[UseEffect]##################################*/
    useEffect(() => {
        ...
        // //calendar
        // axios.post(`${GConf.ApiLink}/forfait/article/calendar`, {
        //     PID : GConf.PID,
        //     code: code, 
        //   })
        // .then(function (response) {
    ...
    const UpdatePhotoFunction = (pathLink) => {
        setLS(true)
        axios.post(`${GConf.ApiLink}/forfait/modifier/image`, {
            PID  :GConf.PID,
            code : code,
            path : pathLink
        }).then(function (response) {
                ...
                <div className='card card-body shadow-sm mb-2 border-div'>
                    ...
                    <div className="img-card-container text-center">
                        <div className="card-container notification bg-white">
                            <img src={`https://cdn.abyedh.com/images/system/Resto/article.png`} className="rounded-circle" width="70px" height="70px" />                    
                        </div>
                    </div>
