...
function FacturePage() {
    ...
    const [selectedArticle, setSelectedArticle] = useState([])
     ...
     /*#########################[UseEffect]##################################*/
     useEffect(() => {
        axios.post(`${GConf.ApiLink}/calendrier`, {
            PID : GConf.PID,
        })
        .then(function (response) {
            ...
            _(<TableImage image='calendrier.png' />),
            getData.OR_ID,
            getData.PA_Name,
            ...
            _(<Button className='rounded-pill bg-system-btn' size='mini' onClick={ (e) => NavigateFunction(`/S/cd/info/${getData.OR_ID}`)}><span className='d-none d-lg-inline'> Info </span><Icon  name='angle right' /></Button>)
            ],))
        ...
        <Modal
            ...
            >
                ...
                <Modal.Actions>
                            ...
                            <Button className='rounded-pill bg-system-btn'   onClick={ (e) => NavigateFunction(`/S/cd/info/${selectedArticle.F_ID}`)}><span className='d-none d-lg-inline'> Info </span><Icon  name='angle right' /></Button>
                </Modal.Actions>
        </Modal>
    </>);
}
