...
const TerminerCard = ({rapportData, setRapportData,allClientList, OnKeyPressFunc}) =>{
    ...
    return (<>
            ...
            <Input icon='text height' onKeyPress={event => OnKeyPressFunc(event)} list="clientList" placeholder={t('menuTabs.rapportPage.addRapport.terminerCard.Titre')}   onBlur={ (e) => setRapportData({...rapportData, RA_Titre: e.target.value })} size="small" iconPosition='left'   fluid className='mb-1' />

            <h5 className='mb-1 mt-1'>{t('menuTabs.rapportPage.addRapport.terminerCard.Sujet')} </h5>
            <Form>
                <TextArea rows={2} placeholder={t('menuTabs.rapportPage.addRapport.terminerCard.Titre')} onKeyPress={event => OnKeyPressFunc(event)} value={rapportData.RA_Sujet} onChange={(e) => setRapportData({...rapportData, RA_Sujet : e.target.value })} />
            </Form>
