...
function RequestInfo() {
    ...
    const SaveClientFunction = () =>{
        ...
        axios.post(`${GConf.ApiLink}/client/ajouter`, {
            PID : GConf.PID,
            patientD : {CIN: '', Name:commandeData.Name, Phone:commandeData.PhoneNum , Gouv:commandeData.BirthGouv, Deleg:commandeData.BirthDeleg, Adress:'', Releted_UID:commandeData.UID},
        }).then(function (response) {
