...
//import OneGConf from '../Assets/Cards/linksData'
    ...
    <>
      <div className="ccard-body mb-2">
        ...
        <Input
          ...
          list="clientList"
          size="large"
          onKeyPress={(e) => SetClientCredit(e)}
          iconPosition="left"
  ...
  const CalculateBons = (genre) => {
    if (genre == "Plus") {
      return {
        ...
        bon: keyBonsValue,
        valeur: selectedBon,
        pourcentage: selectedPoucentage,
      };
    } else {
      return {
              ...
              <div className="row ">
                <div className="col-12">
                  <Button
                    ...
                    onClick={() => GetArticleDataByAID(keyBordI)}
                  >
                    {" "}
                ...
                <div className="col-6 d-none">
                  <Button
                    ...
                    className={`border-div ${
                      peseState ? "bg-warning text-white" : "bg-white border "
                    }`}
                    onClick={() => setPeseState(!peseState)}
                  >
                    {" "}
                    <Icon name="balance" /> Pesé{" "}
                  </Button>
                </div>
              </div>
              {/* <h5>Enregistrer </h5> 
