...
const GConf = {
    ...
    // main variables
    PID: GetPID(),
    ApiLink : 'https://api.abyedh.com/api/systems/hotel', //https://api.abyedh.com/api/systems/System 
    ApiRouterOneLink : 'https://api.abyedh.com/api/systems/hotel-caisse', //https://api.abyedh.com/api/systems/System 
    ApiRouterTwoLink : 'https://api.abyedh.com/api/systems/hotel-serveur', //https://api.abyedh.com/api/systems/System 
    ApiRouterThreeLink : 'https://api.abyedh.com/api/systems/hotel-chef', //https://api.abyedh.com/api/systems/System 
    DefaultTva: 0,
    themeColor : '#247cc7',
    ...
    NavsData : [
            ...
            {id:5, name:"Chambres", icon:"pc-display-horizontal", link:"ch"},
            {id:7, name:"Service", icon:"box-seam", link:"sv"},
