                    ...
                    <div className='col-12 col-lg-8'>
                        ...
                        <div className='row'>
                            <div className='col-6'>
                                ...
                                <Input icon='truck' type='date' placeholder='Camion'  iconPosition='left'   fluid className='mb-1 shadow-sm' value={seanceD.SE_Date} onChange={(e) => setSeanceD({...seanceD, SE_Date: e.target.value })}/> 
                            </div>
                            <div className='col-6'>
