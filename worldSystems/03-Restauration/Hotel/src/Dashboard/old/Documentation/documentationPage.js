    ...
    <>
      <div className="row ">
        <div className="col-10 align-self-center">
          <Form>
            <TextArea
              placeholder="Ajouter Notes ici"
              value={msgContent}
              className="mb-2 rounded-pill"
              rows="1"
              onChange={(e) => setMesgC(e.target.value)}
            ></TextArea>
          </Form>
        </div>
...
function DocumentationPage() {
  ...
  useEffect(() => {
    axios
      .post(`${GConf.ApiLink}/documentation/messages`, {
        PID: GConf.PID,
      })
  ...
  const MenuItemCard = (props) => {
    return (
      <>
        <div
          className={`card p-2 rounded mb-1 btn ${
            activeIndex == props.activeI ? "activeDocItem " : ""
          }`}
          onClick={() => setActiveIndex(props.activeI)}
        >
          <div className="row">
            <div className="col-4 system-color">
              <span className={`bi bi-${props.icon} bi-xsm`}></span>
            </div>
  ...
  const TabCard = (props) => {
    return (
      <>
        <span className=" ms-1 me-2 border-bottom border-dark border-2">
          {" "}
          {props.text} <Icon name={props.icon} className="me-0" />
        </span>
      </>
    );
  };
  const NavCard = (props) => {
    return (
      <>
        <span className="ms-2 me-2 abyedh-list-a p-2">
          {" "}
          {props.text} <span className={`bi bi-${props.icon}`}></span>
        </span>
      </>
    );
  };
  const NavTabCard = (props) => {
    return (
      <>
        <span className=" bg-gray rounded p-2">
          {" "}
          {props.text} <span className={`bi bi-${props.icon}`}></span>
        </span>
      </>
  ...
  const ButtonCard = (props) => {
    return (
      <>
        <span
          size="small"
          className="rounded-pill btn-imprimer ps-3 pe-3 pt-2 pb-2 d-inline-block"
        >
          {" "}
          <Icon
            name={props.icon}
            className={`${props.reversed ? "" : "d-none"}`}
          />{" "}
          {props.text}{" "}
          <Icon
            name={props.icon}
  ...
  const SubMainLinkCard = (props) => {
    return (
      <>
        <span
          size="small"
          className="rounded-pill  border  ps-3 pe-3 pt-2 pb-2 d-inline-block shadow-sm"
          fluid
          icon
      ...
      <>
        <Accordion fluid styled dir="rtl" className="mb-4">
          <Accordion.Title
            ...
            onClick={() => {
              activeAccoedIndex === 0
                ? setActiveAccordIndex(1000)
                : setActiveAccordIndex(0);
            }}
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              قبول و تأكيد إشتراك{" "}
              <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
            ...
            <div className="row mb-5">
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> قم بالنقر علي </span>
                    <NavCard text="Souscription" icon="receipt-cutoff" />{" "}
                  </li>
                  {/* <li className='mb-3'> <span className='font-hs-n '> قم بالنقر علي </span><NavTabCard text='Commande' icon='cart-dash' /> </li> */}
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n ">
                      {" "}
                      إختر الطلب المستهدف بالنقر علي{" "}
                    </span>{" "}
                    <ButtonCard text="Info" reversed icon="arrow right" />{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n ">
                      {" "}
                      ستضهر لك معلومات طلب الإشتراك . إختر Annulee أو S'abonner
                      حسب الحالة التي تريد{" "}
                    </span>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n ">
                      {" "}
                      في حالة S'abonner قم بادخال معلومات الإشتراك المطلوبة ثم
                      أنقر علي{" "}
                    </span>{" "}
                    <ButtonCard text="Enregistrer" icon="save" />{" "}
                  </li>
                </ul>
              </div>
        ...
        <Accordion fluid styled dir="rtl" className="mb-4">
              ...
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> قم بالنقر علي </span>
                    <NavCard text="Menu" icon="receipt-cutoff" />{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> قم بالنقر علي </span>{" "}
                    <b className="ms-2 me-2"> "Nouveaux Plat" </b>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n ">
                      {" "}
                      قم بإدخال جميع بيانات الطبق{" "}
                    </span>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> أنقر علي زر </span>{" "}
                    <ButtonCard text="Enregistrer" icon="save" />{" "}
                  </li>
                </ul>
              </div>
          ...
          <Accordion.Title
            ...
            onClick={() => {
              activeAccoedIndex === 1
                ? setActiveAccordIndex(1000)
                : setActiveAccordIndex(1);
            }}
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              تعديل معلومات ألة <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
          <Accordion.Content active={activeAccoedIndex === 1}>
            <div className="row mb-5 mt-4">
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  ...
                  <li className="mb-3">
                    ...
                    <span className="font-hs-n ">
                      {" "}
                      إختر الطبق المستهدف بالنقر علي{" "}
                    </span>{" "}
                    <ButtonCard text="Info" reversed icon="arrow right" />{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> إختر </span>{" "}
                    <TabCard text="Modifier" icon="edit" />{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n ">
                      {" "}
                      قم بتعديل بيانات الطبق{" "}
                    </span>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> أنقر علي زر </span>{" "}
                    <ButtonCard text="Modifier" icon="edit" />{" "}
                  </li>
                </ul>
              </div>
              <div className="col-12 col-lg-6 align-self-center">
          ...
          <Accordion.Title
            ...
            onClick={() => {
              activeAccoedIndex === 3
                ? setActiveAccordIndex(1000)
                : setActiveAccordIndex(3);
            }}
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              تغيير صورة ألة <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
              ...
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  ...
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> إختر </span>{" "}
                    <TabCard text="Image" icon="image" />{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n ">
                      {" "}
                      قم بتعديل مكونات الطبق{" "}
                    </span>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
          ...
          <Accordion.Title
            ...
            onClick={() => {
              activeAccoedIndex === 4
                ? setActiveAccordIndex(1000)
                : setActiveAccordIndex(4);
            }}
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              إضافة Familles des equipemment{" "}
              <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
              ...
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  ...
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> قم بالنقر علي </span>{" "}
                    <b className="ms-2 me-2"> "Famille des Plats" </b>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n ">
                      {" "}
                      علي اليمين قم بإدخال جميع بيانات عائلة الأطباق الجديدة{" "}
                    </span>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
          ...
          <Accordion.Title
            ...
            onClick={() => {
              activeAccoedIndex === 5
                ? setActiveAccordIndex(1000)
                : setActiveAccordIndex(5);
            }}
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              تغيير Familles des equipemment{" "}
              <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
              ...
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  ...
                  <li className="mb-3">
                    ...
                    <span className="font-hs-n ">
                      {" "}
                      علي يمين العائلة قم بالنقر علي{" "}
                    </span>{" "}
                    <b className="ms-2 me-2">
                      {" "}
                      <span
                        className="btn rounded-circle "
                        style={{ backgroundColor: GConf.themeColor }}
                      >
                        <span className="bi bi-pencil-square text-white"></span>
                      </span>{" "}
                    </b>{" "}
                  </li>
                  <li className="mb-3">
                    ...
                    <span className="font-hs-n ">
                      {" "}
                      ستضهر لك نافدة علي الشاشة قم من خلالها بتغيير المعلومات
                      المطلوبة
                    </span>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> أنقر علي زر </span>{" "}
                    <ButtonCard text="Modifier" icon="save" />{" "}
                  </li>
                </ul>
              </div>
              <div className="col-12 col-lg-6 align-self-center">
      ...
      <>
        <Accordion fluid styled dir="rtl" className="mb-4">
              ...
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> قم بالنقر علي </span>
                    <NavCard text="Caisse" icon="pc-display-horizontal" />{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> قم بالنقر علي </span>{" "}
                    <b className="ms-2 me-2"> "Ajouter Caisse" </b>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n ">
                      {" "}
                      قم بإدخال جميع بيانات الـ Caisse{" "}
                    </span>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
          ...
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              تعديل معلومات حصة <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
          <Accordion.Content active={activeAccoedIndex === 1}>
            <div className="row mb-5 mt-4">
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  ...
                  <li className="mb-3">
                    ...
                    <span className="font-hs-n ">
                      {" "}
                      قم بتعديل بيانات الـ الـCaisse{" "}
                    </span>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
          ...
          <Accordion.Title
            ...
            onClick={() => {
              activeAccoedIndex === 2
                ? setActiveAccordIndex(1000)
                : setActiveAccordIndex(2);
            }}
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              حذف حصة <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
          <Accordion.Content active={activeAccoedIndex === 2}>
            <div className="row mb-5 mt-4">
      ...
      <>
        <Accordion fluid styled dir="rtl" className="mb-4">
          ...
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              إضافة إشتراك جديد <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
          <Accordion.Content
            active={activeAccoedIndex === 0}
              ...
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> قم بالنقر علي </span>
                    <NavCard text="Abonnemment" icon="receipt-cutoff" />{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n ">
                      {" "}
                      إختر إشتراك بالنقر علي{" "}
                    </span>{" "}
                    <ButtonCard text="Info" reversed icon="arrow right" />{" "}
                  </li>
                  <li className="mb-3">
                    ...
                    <span className="font-hs-n ">
                      {" "}
                      يمكنك من خلال الواجهة التي ضهرت أن تقوم بمتابعة عدد الحصص
                      المسجلة و الحصص المتبقية{" "}
                    </span>{" "}
                  </li>
                </ul>
              </div>
          ...
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              تلخيص الإشتراكات حسب مدة زمنية{" "}
              <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
          <Accordion.Content active={activeAccoedIndex === 2}>
              ...
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> قم بالنقر علي </span>
                    <NavCard text="Facture" icon="receipt-cutoff" />{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> قم بالنقر علي </span>{" "}
                    <b className="ms-2 me-2"> "Resumer" </b>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n ">
                      {" "}
                      قم بإدخال تاريخ بذأ و نهاية التلخيص{" "}
                    </span>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> أنقر علي زر </span>{" "}
                    <ButtonCard text="Recherche" icon="search" />{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n ">
                    ...
                    <ButtonCard text="Imprimer" icon="print" />{" "}
                  </li>
                </ul>
              </div>
              <div className="col-12 col-lg-6 align-self-center">
          ...
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              تجديد إشتراك <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
          <Accordion.Content
            active={activeAccoedIndex === 5}
          ...
          <Accordion.Title
            ...
            onClick={() => {
              activeAccoedIndex === 6
                ? setActiveAccordIndex(1000)
                : setActiveAccordIndex(6);
            }}
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              إضافة Offre <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
          <Accordion.Content active={activeAccoedIndex === 6}>
            <div className="row mb-5 mt-4">
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  ...
                  <li className="mb-3">
                    ...
                    <b className="ms-2 me-2">
                      {" "}
                      <SubMainLinkCard text="Stock" icon="box-seam-fill" />{" "}
                    </b>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
      ...
      <>
        <Accordion fluid styled dir="rtl" className="mb-4">
              ...
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> قم بالنقر علي </span>
                    <NavCard text="Client" icon="person" />{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> قم بالنقر علي </span>{" "}
                    <b className="ms-2 me-2"> "Nouveaux Client" </b>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n ">
                      {" "}
                      قم بإدخال جميع بيانات الـ Client{" "}
                    </span>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
          ...
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              تعديل معلومات عضو <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
          <Accordion.Content active={activeAccoedIndex === 1}>
            <div className="row mb-5 mt-4">
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  ...
                  <li className="mb-3">
                    ...
                    <span className="font-hs-n ">
                      {" "}
                      قم بتعديل بيانات الـ الـClient{" "}
                    </span>{" "}
                  </li>
                  <li className="mb-3">
                    {" "}
          ...
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              تفعيل عضو <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
          <Accordion.Content active={activeAccoedIndex === 2}>
            <div className="row mb-5 mt-4">
              <div className="col-12 col-lg-6 align-sel-center">
                <ul>
                  ...
                  <li className="mb-3">
                    {" "}
                    <span className="font-hs-n "> أنقر علي زر </span>{" "}
                    <ButtonCard text="Menu" icon="receipt-cutoff" />{" "}
                  </li>
                </ul>
              </div>
              <div className="col-12 col-lg-6 align-self-center">
    ...
    return (
      <>
        <div className="text-secondary  d-none" dir="rtl">
          ...
          <br />
          <div className="row mb-5">
            <h4 className="font-hs-n system-color mb-5 ">
              {" "}
              كيفية إضافة عضو جديد{" "}
            </h4>
            <div className="col-12 col-lg-6 align-sel-center">
              <ul>
                <li className="mb-3">
                  {" "}
                  <span className="font-hs-n "> قم بالنقر علي </span>
                  <NavCard text="Equipe" icon="pc-display-horizontal" />{" "}
                </li>
                <li className="mb-3">
                  {" "}
                  <span className="font-hs-n "> قم بالنقر علي </span>{" "}
                  <b className="ms-2 me-2"> "Nouveaux Membre" </b>{" "}
                </li>
                <li className="mb-3">
                  {" "}
                  <span className="font-hs-n ">
                    {" "}
                    قم بإدخال جميع بيانات العضو الجديد{" "}
                  </span>{" "}
                </li>
                <li className="mb-3">
                  {" "}
          ...
          <div className="row mb-5 mt-4">
            ...
            <div className="col-12 col-lg-6 align-sel-center">
              <ul>
                ...
                <li className="mb-3">
                  {" "}
                  <span className="font-hs-n "> إختر عضو بالنقر علي </span>{" "}
                  <ButtonCard text="Info" reversed icon="arrow right" />{" "}
                </li>
                <li className="mb-3">
                  {" "}
            ...
            <div className="col-12 col-lg-6 align-sel-center">
              <ul>
                <li className="mb-3">
                  {" "}
                  <span className="font-hs-n "> قم بالنقر علي </span>
                  <NavCard text="Equipe" icon="receipt-cutoff" />{" "}
                </li>
                <li className="mb-3">
                  {" "}
                  <span className="font-hs-n "> قم بالنقر علي </span>{" "}
                  <b className="ms-2 me-2"> "Postes" </b>{" "}
                </li>
                <li className="mb-3">
                  {" "}
                  <span className="font-hs-n ">
                    {" "}
                    علي اليمين قم بإدخال جميع بيانات الوضيفة الجديدة{" "}
                  </span>{" "}
                </li>
                <li className="mb-3">
                  {" "}
        ...
        <Accordion fluid styled dir="rtl" className="mb-4">
          ...
          >
            <h4 className="font-hs-n system-color p-3">
              {" "}
              تعديل وضيفة Poste <Icon className="float-start" name="dropdown" />
            </h4>
          </Accordion.Title>
          <Accordion.Content active={activeAccoedIndex === 3}>
            <div className="row mb-5 mt-4">
  ...
  const SendMessage = () => {
    if (!msgContent) {
      toast.error("Message Vide !", GConf.TostErrorGonf);
    } else {
      axios
        .post(`${GConf.ApiLink}/documentation/ajouter`, {
          PID: GConf.PID,
          msgC: msgContent,
        })
        .then(function (response) {
  ...
  const SentMessage = (props) => {
    return (
      <>
        <div className="row">
          <div className="col-2 align-self-center text-end text-secondary">
            <small>{props.content.Sent_Time}</small>
          </div>
              ...
              <div className="flex-grow-1 me-1">
                <div className="text-end">
                  <small className="text-secondary">
                    {new Date(props.content.Sent_Date).toLocaleDateString(
                      "en-US"
                    )}
                  </small>
                </div>
                <div
                  className="card p-2 rounded-message-s mb-3 ps-4 pe-2"
                  style={{ backgroundColor: "#f0d584" }}
                >
        ...
        <div className="row">
          <div className="col-10">
            <div className="d-flex ">
              <div className="flex-shrink-0 ">
                <img
                  src={`https://cdn.abyedh.com/Images/logo/main-lago.gif`}
                  alt="."
              ...
              <div className="flex-grow-1 ms-1">
                ...
                <div
                  className="card p-2 rounded-message-r  mb-3 ps-2 pe-4"
                  style={{ backgroundColor: "#8affc9" }}
                >
                  {props.content.Content}
                </div>
              </div>
          ...
          <div className="col-2 align-self-center text-start text-secondary">
            <small>{props.content.Sent_Time}</small>
          </div>
        </div>
      </>
  ...
  const MessagesDetails = () => {
    return messagesList.map((convMsg, index) =>
      convMsg.Sender == "SYSTEM" ? (
        <SentMessage key={index} content={convMsg} />
      ) : (
        <RecivedMessage key={index} content={convMsg} />
      )
    );
  };
  return (
    <>
      <Link exaxt="true" to="/S/ma">
        <Button className="rounded-circle" icon="arrow left" />
      </Link>
      <br />
      <br />
      <div className="row">
        <div className="col-12 col-lg-3">
          <div className="sticky-top" style={{ top: "70px" }}>
            ...
            <MenuItemCard
              ...
              activeI={3}
            />
            <MenuItemCard text="Mmebres" icon="person" activeI={4} />
            <MenuItemCard
              text="Equipe"
