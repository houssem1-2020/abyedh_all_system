  ...
  return (
    <>
      ...
      <Input
        ...
        defaultValue={articleD.A_Code}
        onChange={(e) => setArticleD({ ...articleD, A_Code: e.target.value })}
      />
      <div className="row">
        <div className="col-12 col-lg-10">
          ...
          <Input
            ...
            placeholder="Nom"
            className="w-100 border-0 shadow-sm rounded mb-3"
            defaultValue={articleD.Name}
            onChange={(e) => setArticleD({ ...articleD, Name: e.target.value })}
          />
        </div>
        <div className="col-12 col-lg-2">
          ...
          <Input
            ...
            placeholder="gpge"
            className="w-100 border-0 shadow-sm rounded mb-3"
            defaultValue={articleD.Groupage}
            onChange={(e) =>
              setArticleD({ ...articleD, Groupage: e.target.value })
            }
          />
        </div>
      </div>
      <div className="row">
        <div className="col-12 col-lg-6">
          ...
          <Select
            placeholder="Selectionez une Categorie"
            options={familles}
            className="w-100 shadow-sm rounded mb-3"
            defaultValue={articleD.Genre}
            onChange={(e, data) =>
              setArticleD({ ...articleD, Genre: data.value })
            }
          />
        </div>
        <div className="col-12 col-lg-6">
          ...
          <Input
            ...
            placeholder="Socité"
            className="w-100 border-0 shadow-sm rounded mb-3"
            defaultValue={articleD.Socite}
            onChange={(e) =>
              setArticleD({ ...articleD, Socite: e.target.value })
            }
          />
        </div>
      </div>
      <div className="row">
        <div className="col-12 col-lg-4">
          ...
          <Input
            ...
            type="number"
            placeholder="achat"
            defaultValue={articleD.Prix_achat}
            onBlur={checkPrixCompatiblite}
            className="w-100 border-0 shadow-sm rounded mb-3"
            onChange={(e) =>
              setArticleD({ ...articleD, Prix_achat: e.target.value })
            }
          />
        </div>
        <div className="col-12 col-lg-4">
          ...
          <Input
            ...
            type="number"
            placeholder="vente"
            defaultValue={articleD.Prix_vente}
            onBlur={checkPrixCompatiblite}
            className="w-100 border-0 shadow-sm rounded mb-3"
            onChange={(e) =>
              setArticleD({ ...articleD, Prix_vente: e.target.value })
            }
          />
        </div>
        <div className="col-12 col-lg-4">
          ...
          <Input
            ...
            placeholder="promo"
            className="w-100 border-0 shadow-sm rounded mb-3"
            defaultValue={articleD.Prix_gros}
            onChange={(e) =>
              setArticleD({ ...articleD, Prix_gros: e.target.value })
            }
          />
        </div>
      </div>
      <div className="row">
        <div className="col-12 col-lg-5">
          ...
          <Input
            ...
            className="w-100 border-0 shadow-sm rounded mb-3"
            defaultValue={articleD.Quantite}
            onChange={(e) =>
              setArticleD({ ...articleD, Quantite: e.target.value })
            }
          />
        </div>
        <div className="col-12 col-lg-5">
          ...
          <Input
            ...
            placeholder="repture"
            className="w-100 border-0 shadow-sm rounded mb-3"
            defaultValue={articleD.Repture}
            onChange={(e) =>
              setArticleD({ ...articleD, Repture: e.target.value })
            }
          />
        </div>
        <div className="col-12 col-lg-2">
          ...
          <Input
            ...
            type="number"
            className="w-100 border-0 shadow-sm rounded mb-3"
            defaultValue={articleD.TVA}
            onChange={(e) => setArticleD({ ...articleD, TVA: e.target.value })}
          />
        </div>
      </div>
      <div className="row">
        ...
        <Form>
          <TextArea
            rows="3"
            defaultValue={articleD.Details}
            className="w-100 shadow-sm rounded mb-3"
            onChange={(e) =>
              setArticleD({ ...articleD, Details: e.target.value })
            }
          />
        </Form>
      </div>
...
function ArticleInfo() {
  ...
  const props = {
    ...
    height: 250,
    zoomWidth: 500,
    img: articleD ? articleD.Photo_Path : "default_img.jpg",
  };
      ...
      render: () => (
        <>
          <Tab.Pane attached={false}>
            <EditArticle
              articleD={articleD}
              setArticleD={setArticleD}
              checkPrixCompatiblite={checkPrixCompatiblite}
              familles={familles}
              EditArticleFunction={EditArticleFunction}
  ...
  useEffect(() => {
    ...
    axios
      .post(`${GConf.ApiLink}/stock/article`, {
        PID: GConf.PID,
        code: code,
      })
    ...
    //calendar
    axios
      .post(`${GConf.ApiLink}/stock/article/calendar`, {
        PID: GConf.PID,
        code: code,
      })
      .then(function (response) {
        let inFactureList = [];
        response.data[0].InFacture.map((factureList) =>
          inFactureList.push({
            title: GetTargetArticleQte(factureList.Articles, "Qte"),
            date: GenerateDate(factureList.Cre_Date, 1),
            className: "bg-primary border-0 w-25 text-center",
          })
        );

        let forCamionList = [];
        response.data[0].ForCamion.map((camionData) =>
          forCamionList.push({
            title: GetTargetArticleQte(camionData.Articles, "QteAjoute"),
            date: GenerateDate(camionData.Jour, 1),
            className: "bg-danger border-0 w-25 text-center",
          })
        );

        let fromBonBE = [];
        response.data[0].bonE.map((bonBe) =>
          fromBonBE.push({
            title: GetTargetArticleQte(bonBe.Articles, "NewQte"),
            date: GenerateDate(bonBe.BE_Date, 1),
            className: "bg-success border-0 w-25 text-center",
          })
        );

        let fromBonBS = [];
        response.data[0].bonS.map((bonBs) =>
          fromBonBE.push({
            title: GetTargetArticleQte(bonBs.Articles, "NewQte"),
            date: GenerateDate(bonBs.BE_Date, 1),
            className: "bg-warning border-0 w-25 text-center",
          })
        );

        //setArticleEvents(inFactureList.concat(forCamionList,fromBonBE,fromBonBS))
        setArticleEvents(
          ConcatunateResult(inFactureList).concat(
            ConcatunateResult(forCamionList),
            ConcatunateResult(fromBonBE),
            ConcatunateResult(fromBonBS)
          )
        );
      });
    ...
    // Find Image
    axios
      .post(`${GConf.ApiLink}/stock/checkAbyedhDb`, {
        Code: code,
      })
      .then(function (response) {
        if (response.data.length != 0) {
          setPhotoExist(response.data);
        }
      });
  ...
  const EditArticleFunction = (event) => {
    ...
    setLS(true);
    axios
      .post(`${GConf.ApiLink}/stock/modifier`, {
        tag: GConf.PID,
        articleND: articleD,
      })
      .then(function (response) {
      ...
      .catch((error) => {
        if (error.request) {
          toast.error(
            <>
              <div>
                <h5>Probleme de Connextion</h5> Impossible de modifier l'article{" "}
              </div>
            </>,
            GConf.TostInternetGonf
          );
  ...
  const UpdatePhotoFunction = (pathLink) => {
    setLS(true);
    axios
      .post(`${GConf.ApiLink}/stock/modifier/image`, {
        PID: GConf.PID,
        code: code,
        path: pathLink,
      })
  ...
  const DeleteArticle = () => {
    setLS(true);
    axios
      .post(`${GConf.ApiLink}/stock/supprimer`, {
        tag: GConf.PID,
        code: code,
        pk: articleD.PK,
      })
  ...
  const ConcatunateResult = (targetArray) => {
    const endresult = Object.values(
      targetArray.reduce((value, object) => {
  ...
  const ArticleCard = (props) => {
    const ReptureState = () => {
      return props.data.Repture >= props.data.Quantite ? (
        <span className="bi bi-exclamation-triangle-fill bi-sm text-danger"></span>
      ) : (
        <span className="bi bi-box2-heart-fill bi-sm text-success"></span>
      );
    };
    return (
      <>
          ...
          <div className="card card-body shadow-sm mb-2 border-div">
            ...
            <div className="img-card-container text-center">
              <div className="card-container">
                <img
                  src={`https://assets.ansl.tn/Images/Articles/${props.data.Photo_Path}`}
            ...
            <div className="mt-5 text-center">
              <h4 className="mt-2">
                {loading ? props.data.Name : SKLT.BarreSkl}{" "}
              </h4>
              ...
              <div className="row text-center">
                <div className="col-12 mb-3">
                  <Statistic color="green" size="tiny">
                    {loading ? (
                      <Statistic.Value>{props.data.Quantite}</Statistic.Value>
                    ) : (
                      SKLT.ProfileSkl
                    )}
                  </Statistic>
    ...
    return (
      <>
        ...
        <div className="row mt-2">
          <div className="col">
            <span className="bi bi-circle-fill text-success "></span> Par Bon
            entre
          </div>
          <div className="col">
            <span className="bi bi-circle-fill text-warning "></span> Par Bon
            Sortie
          </div>
          <div className="col">
            <span className="bi bi-circle-fill text-primary "></span> Dans
            Factures
          </div>
          <div className="col">
            <span className="bi bi-circle-fill text-danger "></span> Vers Camion
          </div>
        </div>
      </>
    );
    ...
    return (
      <>
        <h3 className="text-secondary">
          Voulez-Vous Vraimment Supprimer Cett Article ?
        </h3>
        <div className="row">
          <div className="col-9">
            <h5 className="text-danger text-left">
              <b>Lorsque Vous Supprimer L'Article : </b>
            </h5>
        ...
        <div className="mb-2 row">
          <div className="col-6 mb-3">
            <Input
              ...
              type="date"
              value={resDay.start}
              onChange={(e) => setResDay({ ...resDay, start: e.target.value })}
            />
          </div>
          <div className="col-6 mb-3">
            <Input
              ...
              type="date"
              value={resDay.end}
              onChange={(e) => setResDay({ ...resDay, end: e.target.value })}
            />
          </div>
          <div className="col-6 self-align-center mb-2">
            ...
            <Button
              size="small"
              className="rounded-pill btn-imprimer"
              fluid
              onClick={(e) => PrintFunction("printResumer")}
              icon
            >
              {" "}
              <Icon name="print" /> Imprimer Resumer{" "}
            </Button>
          </div>
          <div className="col-6 self-align-center mb-2">
            <h5>Suivie Vente </h5>
            <Button
              ...
              fluid
              onClick={(e) => PrintFunction("printVente")}
              icon
            >
              {" "}
              <Icon name="print" /> Suivie Vente{" "}
            </Button>
          </div>
        </div>
      </>
  ...
  const Images = () => {
          ...
          <div className="row">
            <div className="col-12 col-lg-7">
              <div className="card p-2 mb-2">
                ...
                >
                  ...
                  <span className="bi bi-cloud-upload-fill bi-sm">
                    {" "}
                    <span className="mb-2 ms-4">CHARGER UNE IMAGE </span>
                  </span>
                </label>
              </div>
            ...
            <div className="col-12 col-lg-5">
              <div className="card card-body  text-center p-4 img-container">
                {displayedImage ? (
                  <img src={displayedImage} width="100%" height="200px" />
                ) : (
                  "PaS d'image"
                )}
              </div>
    ...
    const UpdateImage = () => {
            ...
            <div className="row">
              <div className="col-12 col-lg-4">
                <div className="card card-body  text-center p-4 border-3 img-container">
                  <img
                    src={`https://assets.ansl.tn/Images/Articles/${props.link}`}
                    width="100%"
                    height="200px"
                  />
                </div>
              ...
              <div className="col-12 col-lg-8">
                <Button onClick={(e) => UpdatePhotoFunction(props.link)}>
                  Modifier{" "}
                </Button>
              </div>
            </div>
      ...
      return (
        <>
          {photoExist.Photo_Path ? (
            <UpdateCard link={photoExist.Photo_Path} />
          ) : (
            <>
              {" "}
              Cette article n'est pas connu pour les base de donneé abyedh.com{" "}
            </>
          )}
        </>
      );
        ...
        <>
          <div className="card-body text-center">
            ...
            <ReactImageZoom
              ...
              img={`https://assets.ansl.tn/Images/Articles/${
                articleD ? articleD.Photo_Path : "default_img.jpg"
              }`}
            />
          </div>
        </>
    ...
    return (
      <>
        <div className="p-2 mb-2">
          {articleD.Photo_Path == "default_img.jpg" ? (
            <UpdateImage />
          ) : (
            <ImageExist />
          )}
  ...
  return (
    <>
      ...
      <FrameForPrint
        ...
        src={`/Pr/Stock/resumer/${code}/${resDay.start}/${resDay.end}`}
      />
      <FrameForPrint
        frameId="printVente"
        src={`/Pr/Stock/vente/${code}/${resDay.start}/${resDay.end}`}
      />
    </>
  );
}
