  ...
  return (
    <>
      ...
      <Input
        icon="key"
        iconPosition="left"
        placeholder="Mtricule Fiscale"
        value={generalData.Matricule_F}
        onChange={(e) =>
          setGeneralData({ ...generalData, Matricule_F: e.target.value })
        }
        fluid
      />
...
function ProfilePage() {
  ...
  const UpdateGeneralDataFunc = () => {
    if (!generalData.Matricule_F) {
      toast.error("Matricule est Invalide !", GConf.TostErrorGonf);
    } else if (!generalData.Name) {
        ...
        >
          <div className="text-center ">
            <img
              ...
              src="https://assets.abyedh.com/img/system/ads/storage.svg"
              width="90px"
              height="90px"
            />
            ...
            <div className="d-grid gap-2">
              <a
                ...
                target="_blank"
                href={`https://t.abyedh.com/S/P/storage/${GConf.PID}`}
              >
          ...
          <div className="flex-grow-1 ms-3">
            ...
            <div className="mt-2">
              ...
              <Button
                ...
                primary
                target="_blank"
                href={`https://www.facebook.com/sharer/sharer.php?u=https://t.abyedh.com/S/P/storage/${GConf.PID}`}
              >
                {" "}
            ...
            <div className="row">
              ...
              <div className="col-10">
                <div className=" text-center p-4  ">
                  {displayedImage ? (
                    <img src={displayedImage} width="300px" height="160px" />
                  ) : (
                    "PaS d'image"
                  )}
                </div>
          ...
          <div className="col-6">
            <div className="card p-2 mb-2 border-div">
              ...
              <Button
                ...
                className="rounded-pill bg-system-btn"
                size="tiny"
                onClick={() => UpdateImageFunc("Profile")}
              >
          ...
          <div className="col-6">
            <div className="card p-2 mb-2 border-div">
              ...
              <Button
                ...
                className="rounded-pill bg-system-btn"
                size="tiny"
                onClick={() => UpdateImageFunc("Image1")}
              >
                <Icon name="save" /> Enregistreé{" "}
                <Loader
                  inverted
          ...
          <div className="col-6">
            <div className="card p-2 mb-2 border-div">
              ...
              <Button
                ...
                className="rounded-pill bg-system-btn"
                size="tiny"
                onClick={() => UpdateImageFunc("Image2")}
              >
                <Icon name="save" /> Enregistreé{" "}
                <Loader
                  inverted
          ...
          <div className="col-6">
            <div className="card p-2 mb-2 border-div">
              ...
              <Button
                ...
                className="rounded-pill bg-system-btn"
                size="tiny"
                onClick={() => UpdateImageFunc("Image3")}
              >
                <Icon name="save" /> Enregistreé{" "}
                <Loader
                  inverted
          ...
          <div className="col-6">
            <div className="card p-2 mb-2 border-div">
              ...
              <Button
                ...
                className="rounded-pill bg-system-btn"
                size="tiny"
                onClick={() => UpdateImageFunc("Image4")}
              >
                <Icon name="save" /> Enregistreé{" "}
                <Loader
                  inverted
          ...
          <div className="col-6">
            <div className="card p-2 mb-2 border-div">
              ...
              <Button
                ...
                className="rounded-pill bg-system-btn"
                size="tiny"
                onClick={() => UpdateImageFunc("Image5")}
              >
                <Icon name="save" /> Enregistreé{" "}
                <Loader
                  inverted
        ...
        <div className="card card-body shadow-sm border-div mb-2 text-center">
          ...
          <div className="row">
            <div className="col-4 align-self-center">
              ...
              />
              <h6 className="pt-2">
                {loading ? profileData.review.length : 0}{" "}
              </h6>
            </div>
            <div className="col-8">
              <RatingBar
            ...
            <div className="card card-body shadow-sm mb-2 border-div">
              ...
              >
                <h2 className="text-center">
                  {profileData.likes ? profileData.likes.length : "..."}
                </h2>
                <AvatarGroup
