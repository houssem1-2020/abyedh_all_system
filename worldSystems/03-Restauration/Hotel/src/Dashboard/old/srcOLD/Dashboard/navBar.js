    ...
    return (
      <>
        <NavLink
          exact="true"
          className={({ isActive }) =>
            isActive ? "p-2 abyedh-list-a" : "p-2 abyedh-list"
          }
          to={props.link}
        >
          <i className={`icons-a bi bi-${props.icon}`}></i> {props.name}{" "}
          ...
          <div className="row">
            ...
            <div className="col-5 col-md-8 align-self-center text-left navsha">
              ...
              <Modal
                ...
                dimmer="blurring"
                trigger={
                  <Button className="d-lg-none rounded-pill bg-system-btn">
                    {" "}
              ...
              >
                <Modal.Content className="d-block">
                  <div className="p-2 text-start">
                    {GConf.NavsData.map((links) => (
                      <div className="mb-2" key={links.id}>
                        <MainLink
                          name={links.name}
                          link={links.link}
                          icon={links.icon}
            ...
            <div className="col-4 col-md-2 align-self-center text-end">
              <div className="dropdown d-none">
                <NavLink
                  ...
                  className="ps-1 pe-1"
                >
                  <span className="bi bi-arrow-clockwise fa-lg text-danger"></span>
                </NavLink>
                <NavLink
                  to="nt"
                  exact="true"
                  className={({ isActive }) =>
                    isActive
                      ? "ps-1 pe-1 abyedh-list-a-s"
                      : "ps-1 pe-1 abyedh-list"
                  }
                >
                ...
                <NavLink
                  ...
                  className="ps-1 pe-1"
                >
                  <span className="bi bi-box-arrow-left fa-lg"></span>
                </NavLink>
              </div>
              <NavLink
                onClick={Refresh}
              ...
              <Modal
                ...
                trigger={
                  <Button
                    className=" rounded-circle bg-system-btn"
                    size="tiny"
                    icon
                  >
                    {" "}
                ...
                <Modal.Content className="d-block">
                  <div className="row">
                    <div className="col-4 col-lg align-self-center text-center d-none">
                      ...
                      >
                        <i className="bi bi-bell bi-md "></i>
                      </NavLink>
                      <h6>Notification</h6>
                    </div>
                    <div className="col-4 col-lg align-self-center text-center d-none">
                      ...
                      >
                        <i className="bi bi-envelope bi-md"></i>
                      </NavLink>
                      <h6>Messages</h6>
                    </div>
                    <div className="col-4 col-lg align-self-center text-center ">
                      ...
                      >
                        <i className="bi bi-person bi-md"></i>
                      </NavLink>
                      <h6>Profile</h6>
                    </div>
                    <div className="col-4 col-lg align-self-center text-center  ">
                      ...
                      >
                        <i className="bi bi-sliders bi-md"></i>
                      </NavLink>
                      <h6>Paramétre</h6>
                    </div>
                    <div className="col-4 col-lg align-self-center text-center  ">
                      ...
                      >
                        <i className="bi bi-arrow-repeat bi-md"></i>
                      </NavLink>
                      <h6>Synchroniser</h6>
                    </div>
                    ...
                    <div className="col-4 col-lg align-self-center text-center">
                      <NavLink
                        ...
                        className="ps-1 pe-1"
                      >
                        <span className="bi bi-box-arrow-left bi-md"></span>
                      </NavLink>
                      <h6>Déconnextion</h6>
                    </div>
                  </div>
