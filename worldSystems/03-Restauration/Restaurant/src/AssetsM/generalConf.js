...
const GConf = {
    ...
    PID: GetPID(),
    Country : GetCountry(),
    ApiLink : 'https://api.abyedh.com/api/systems/restaurant', //https://api.abyedh.com/api/systems/System 
    ApiRouterOneLink : 'https://api.abyedh.com/api/systems/restaurant-caisse', //https://api.abyedh.com/api/systems/System 
    ApiRouterTwoLink : 'https://api.abyedh.com/api/systems/restaurant-serveur', //https://api.abyedh.com/api/systems/System 
    ApiRouterThreeLink : 'https://api.abyedh.com/api/systems/restaurant-chef', //https://api.abyedh.com/api/systems/System 
    ...
    //Subsystems
    SubSystemLink : [
        {id: 1, title:'Caisse', text:'Interface Pour La Caisse', icon:'pc-display', link:'/C'},
        {id: 2, title:'Serveur', text:'Interface Pour Passer Des Commandes', icon:'pencil-square', link:'/R'},
    ],

    //NavBar Items
    NavsData : [
            {id:1, name:"Acceuil", icon:"house", link:"ma"},
            {id:2, name:"Commandes", icon:"clipboard-check", link:"rq"},
            {id:3, name:"Commandes", icon:"calendar2-check", link:"rs"},
