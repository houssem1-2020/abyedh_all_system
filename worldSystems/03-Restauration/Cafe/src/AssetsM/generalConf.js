...
const GConf = {
    ...
    // main variables
    PID: GetPID(),
    ApiLink : 'https://api.abyedh.com/api/systems/cafe', //https://api.abyedh.com/api/systems/System 
    ApiRouterOneLink : 'https://api.abyedh.com/api/systems/cafe-caisse', //https://api.abyedh.com/api/systems/System 
    ApiRouterTwoLink : 'https://api.abyedh.com/api/systems/cafe-serveur', //https://api.abyedh.com/api/systems/System 
    ApiRouterThreeLink : 'https://api.abyedh.com/api/systems/cafe-chef', //https://api.abyedh.com/api/systems/System 
    DefaultTva: 0,
    themeColor : '#363636',
