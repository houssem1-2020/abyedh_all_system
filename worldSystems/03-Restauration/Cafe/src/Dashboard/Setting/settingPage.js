            ...
            return(<>
                <div className="row p-2">
                    ...
                    <div className="col-12 col-lg-8 text-start">
                        ...
                        <p className='abyedh-text'>Votre Compte est Confirmé sur l'aunnaire du abyedh.com </p>
                    </div>
                </div>
            </>)
        }
            ...
            return(<>
                <div className="row p-2">
                    ...
                    <div className="col-12 col-lg-6 text-start">
                        ...
                        <p className='abyedh-text'>Votre Compte n'est Confirmé sur l'aunnaire du abyedh.com </p>
                    </div>
