...
const GConf = {
    ...
    PID: GetPID(),
    Country : GetCountry(),
    ApiLink : 'https://api.abyedh.com/api/systems/gym', //https://api.abyedh.com/api/systems/System 
    ApiRouterOneLink : 'https://api.abyedh.com/api/systems/gym-presence', //https://api.abyedh.com/api/systems/System 
    ApiRouterTwoLink : 'https://api.abyedh.com/api/systems/gym-serveur', //https://api.abyedh.com/api/systems/System 
    ApiRouterThreeLink : 'https://api.abyedh.com/api/systems/gym-chef', //https://api.abyedh.com/api/systems/System 
    ...
    //Subsystems
    SubSystemLink : [
        {id: 3, title:'Assistant', text:'Interface Pour L\'assistant', icon:'pc-display', link:'/C'},
    ...
    NavsData : [
            ...
            {id:2, name:"Souscription", icon:"calendar2-check", link:"rq"},
            // {id:6, name:"Offres", icon:"upc-scan", link:"mu"},
            {id:4, name:"Abonnement", icon:"receipt-cutoff", link:"ab"},
            {id:6, name:"Seances", icon:"clock", link:"sa"},
            {id:7, name:"Membres", icon:"people", link:"mb"},
            // {id:3, name:"Emlpoi", icon:"file-earmark-spreadsheet", link:"em"},
            {id:5, name:"Equipement", icon:"pc-display-horizontal", link:"eq"},
    ...
    TableHead:{
        ...
        client:['*','Nom','Matricule', 'Tel', 'Groupe', 'Location','Adresse','Voir'],
