  ...
  translation: {
    menusAndTabsName: {
      ...
      alternativeLink: {
        1: {
          title: "Assistent",
          descrip: "Schnittstelle für den Assistenten"
        },
        2: {
          title: "Kalender",
          descrip: "Schnittstelle für den Kalender",
        },
      },
    },
    communUsed: {
      ...
      paymmentPage: {
        ...
        textOne:
          "Zahlung erfolgt über eine Überweisung über den Moneygram-Dienst",
        textTwo: " zum Eigentümer",
        textThree: "Telefon",
        afterFinishAlert:
          "Nach Abschluss der Überweisung müssen Sie hier die Informationen eingeben:",
      ...
      sysncroPage: {
        ...
        mainCard: {
          topText:
            "Klicken Sie auf die Schaltfläche, um Ihre Daten zu aktualisieren",
          bottomText:
            "Wenn Sie die Daten auf dem Internetserver aktualisieren, können Sie Ihre Anwendung auch im Offline-Modus verwenden. Bleiben Sie immer auf dem neuesten Stand",
    ...
    menuTabs: {
      ...
      rdvPage: {
        ...
        infoBtn: "Info",
        tableHeaderItems:
          "'*','ID','Patient', 'Vergangen am','Volumen','Zeit','Zustand','Aufgenommen?','Ansehen'",
        calendarCardData: {
      ...
      seancePage: {
        ...
        addSeanceInfo: {
          ...
          terminerTabsData: {
            ...
            pasGenre: {
              one: "Keine Art gespeichert",
              two: "Klicken Sie hier",
              three: "um eine hinzuzufügen ",
            },
            saveBtn: "Speichern",
        ...
        resumerCard: {
          ...
          rechercheBtn: "Suchen",
          tableHeader:
            "'*','Patient','Krankheit','Grad','Tag','Zeit','Anzeigen'",
        },
        tarifCard: {
      ...
      patientPage: {
        ...
        patientInfo: {
          ...
          deleteCard: {
            ...
            conscOne:
              "Der Patient wird im Zweig „Patienten“ nicht mehr angezeigt",
            conscTwo:
              "Alle mit diesem Patienten verbundenen Daten können beschädigt werden",
            conscThree:
              "Sie können keine Rechnungen oder Bestellungen mehr mit diesem Patienten erstellen",
      ...
      ordonancePage: {
        ...
        stockCard: {
          ...
          infoCard: {
            ...
            alertTer:
              "Sie können dieses Medikament nicht bearbeiten oder löschen, da es sich um ein öffentliches Medikament handelt.",
            deleteCard: {
              mainTitle: "Möchten Sie dieses Medikament wirklich löschen?",
              alertText: "Beim Löschen eines Medikaments",
              conscOne:
                'Das Medikament wird im Bereich "Medikamente" nicht mehr sichtbar sein.',
              conscTwo:
                "Alle mit diesem Medikament verbundenen Daten können beschädigt werden.",
              conscThree:
                "Sie können keine Rechnungen oder Bestellungen mit diesem Medikament mehr bearbeiten.",
              deleteBtn: "Ja, löschen",
            },
          },
        },
      ...
      teamPage: {
        ...
        teamInfoPage: {
          ...
          deleteCard: {
            ...
            conscOne:
              'Das Mitglied ist in der "Mitglieder" -Zweig nicht sichtbar',
            conscTwo:
              "Alle mit diesem Mitglied verbundenen Daten können beschädigt werden",
            conscThree:
              "Sie können keine Rechnungen oder Bestellungen mit diesem Mitglied sonst durchführen",
            deleteBtn: "Ja, löschen",
          },
        },
      },
    ...
    TableHead: {
      seance:
        "'*','ID','Patient','Krankheit','Grad','Tag','Zeit','Analyse','Rezept','Ansehen'",
      seance:
        "'*','ID','Patient','Krankheit','Grad','Tag','Zeit','Analyse','Rezept','Ansehen'",
      facture:
        "'*','ID','Kasse','Kunde','Tag','Zeit','Gesamt','Status','Ansehen'",
      ordonance:
        "'*','ID','Patient','Datum','Zeit','Sitzung?','Status','Ansehen'",
      seances: "'*','ID','Kasse','Kunde','Tag','Zeit','Status','Ansehen'",
      request: "'*','ID','Kunde', 'Datum','Tabelle','Status','X','Ansehen'",
      reservation:
        "'*','ID','Patient', 'Vorbei','Volumen','Zeit','Status','Aufgenommen?','Ansehen'",
      menu: "'*','Code', 'Name', 'Art','Kosten','Verkaufspreis','X','Ansehen'",
      stock: "'*','Code', 'Name', 'Art','Preis','Ansehen'",
      camion:
        "'*','Lastwagen','Kennzeichen', 'Fahrer','Fonds','Einnahmen','X','Ansehen'",
      ...
      medicammentPage:
        "'*','Code','Art','Name', 'Dosierung','Form', 'Präsentation','Klasse','Ansehen'",
