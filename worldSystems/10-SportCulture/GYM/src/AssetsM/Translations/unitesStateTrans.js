  ...
  translation: {
    menusAndTabsName: {
      ...
      alternativeLink: {
        1: {
          title: "Assistant",
          descrip: "Interface for the assistant"
          },
        2: {
          title: "Calendar",
    ...
    communUsed: {
      ...
      paymmentPage: {
        ...
        textThree: "Telephone",
        afterFinishAlert:
          "After completing the transfer, you must enter the information here:",
      ...
      sysncroPage: {
        ...
        mainCard: {
          ...
          bottomText:
            "When you update the data stored on the internet server, you can also use your application in Offline mode, always stay updated",
          btnText: "Update",
        },
        itemsList: {
          1: "Appointments",
    ...
    menuTabs: {
      ...
      rdvPage: {
        ...
        infoBtn: "Info",
        tableHeaderItems:
          "'*','ID','Patient', 'Past','Volume','Time','State','Recorded?','View'",
        calendarCardData: {
      ...
      patientPage: {
        ...
        patientInfo: {
          ...
          deleteCard: {
            ...
            conscOne:
              'The Patient will no longer be visible in the "Patients" branch',
            conscTwo: "All data related to this Patient may be damaged",
            conscThree:
              "You will not be able to create invoices or orders with this Patient anymore",
      ...
      ordonancePage: {
        ...
        stockCard: {
          ...
          infoCard: {
            ...
            alertTer:
              "You cannot edit or delete this medicine because it is a public medicine.",
            deleteCard: {
              mainTitle: "Are you sure you want to delete this medicine?",
              alertText: "When deleting a medicine",
              conscOne:
                'The medicine will no longer be visible in the "Medicines" branch.',
              conscTwo:
                "All data associated with this medicine may be damaged.",
              conscThree:
                "You will not be able to process invoices or orders with this medicine.",
              deleteBtn: "Yes, delete",
            },
          },
        },
      ...
      teamPage: {
        ...
        teamInfoPage: {
          ...
          deleteCard: {
            ...
            conscThree:
              "You cannot issue invoices or orders with this Member otherwise",
            deleteBtn: "Yes, Delete",
          },
        },
      },
    ...
    TableHead: {
      seance:
        "'*','ID','Patient','Disease','Degree','Day','Time','Analysis','Prescription','View'",
      seance:
        "'*','ID','Patient','Disease','Degree','Day','Time','Analysis','Prescription','View'",
      facture:
        "'*','ID','Cashier','Client','Day','Time','Total','Status','View'",
      ...
      reservation:
        "'*','ID','Patient','Past','Volume','Time','Status','Recorded?','View'",
      ...
      medicammentPage:
        "'*','Code','Genre','Name','Dosage','Form','Presentation','Class','View'",
