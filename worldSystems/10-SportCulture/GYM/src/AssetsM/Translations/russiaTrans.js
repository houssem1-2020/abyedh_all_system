  ...
  translation: {
    menusAndTabsName: {
      ...
      alternativeLink: {
        1: {
          title: "Ассистент",
          descrip: "Интерфейс для ассистента"
          },
        2: {
          title: "Календарь",
          descrip: "Интерфейс для календаря",
        },
      },
    },
    communUsed: {
      ...
      paymmentPage: {
        ...
        textOne:
          "Оплата производится посредством перевода через службу Moneygram  ",
        textTwo: " владельцу",
        textThree: "Телефон",
        afterFinishAlert:
          "После завершения перевода вы должны ввести информацию здесь:",
      ...
      sysncroPage: {
        ...
        mainCard: {
          ...
          bottomText:
            "После обновления данных, сохраненных на интернет-сервере, вы также можете использовать приложение в автономном режиме. Будьте в курсе последних событий",
          btnText: "Обновить",
        },
        itemsList: {
          1: "Встречи",
    ...
    menuTabs: {
      ...
      rdvPage: {
        ...
        infoBtn: "Информация",
        tableHeaderItems:
          "'*','ID','Пациент', 'Прошло','Объем','Время','Состояние','Зарегистрировано?','Показать'",
        calendarCardData: {
      ...
      seancePage: {
        ...
        resumerCard: {
          ...
          rechercheBtn: "Поиск",
          tableHeader:
            "'*','Пациент','Болезнь','Степень','День','Время','Просмотр'",
        },
        tarifCard: {
      ...
      patientPage: {
        ...
        patientInfo: {
          ...
          deleteCard: {
            ...
            conscTwo:
              "Все данные, связанные с этим пациентом, могут быть повреждены",
            conscThree:
              "Вы не сможете создавать счета или заказы с этим пациентом",
      ...
      ordonancePage: {
        ...
        stockCard: {
          ...
          infoCard: {
            ...
            alertTer:
              "Вы не можете изменить или удалить это лекарство, потому что оно является общественным.",
            deleteCard: {
              mainTitle: "Вы уверены, что хотите удалить это лекарство?",
              alertText: "При удалении лекарства",
              conscOne:
                'Лекарство больше не будет видно в разделе "Лекарства".',
              conscTwo:
                "Все данные, связанные с этим лекарством, могут быть повреждены.",
              conscThree:
                "Вы не сможете обрабатывать счета или заказы с этим лекарством.",
              deleteBtn: "Да, удалить",
            },
          },
        },
      ...
      teamPage: {
        ...
        teamInfoPage: {
          ...
          avanceTableaHeders:
            "'ID','Клиент','День','Время','Всего','Посмотреть'",
          editCard: {
            cin: "Карта CIN",
            nomEtPrenon: "Имя и фамилия:",
            phoneNum: "Телефон ",
          ...
          deleteCard: {
            ...
            conscTwo:
              "Все данные, связанные с этим участником, могут быть повреждены",
            conscThree:
              "В противном случае вы не сможете создавать ни счета, ни заказы с этим участником",
            deleteBtn: "Да, удалить",
          },
        },
      },
    ...
    TableHead: {
      seance:
        "'*','ID','Пациент','Заболевание','Степень','День','Время','Анализ','Назначение','Просмотр'",
      seance:
        "'*','ID','Пациент','Заболевание','Степень','День','Время','Анализ','Назначение','Просмотр'",
      facture:
        "'*','ID','Касса','Клиент','День','Время','Всего','Статус','Просмотр'",
      ordonance:
        "'*','ID','Пациент','Дата','Время','Сессия?','Статус','Просмотр'",
      seances: "'*','ID','Касса','Клиент','День','Время','Статус','Просмотр'",
      request: "'*','ID','Клиент','Дата','Таблица','Статус','X','Просмотр'",
      reservation:
        "'*','ID','Пациент','Прошло','Объем','Время','Статус','Записано?','Просмотр'",
      menu: "'*','Код','Название','Жанр','Стоимость','Цена продажи','X','Просмотр'",
      stock: "'*','Код','Название','Жанр','Тариф','Просмотр'",
      camion:
        "'*','Грузовик','Номерной знак','Водитель','Фонд','Прибыль','X','Просмотр'",
      ...
      medicammentPage:
        "'*','Код','Жанр','Название','Дозировка','Форма','Представление','Класс','Просмотр'",
      fournisseur:
        "'*','MF','Название','Телефон','Адрес','Жанр','День','Просмотр'",
    },
    BreadCrumb: {
      menuAddPlat: {
        1: "Меню",
