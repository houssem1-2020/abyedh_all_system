const JapanTrans = {
  translation: {
    ...
    communUsed: {
      ...
      sysncroPage: {
        ...
        mainCard: {
          ...
          bottomText:
            "インターネットサーバーに保存されたデータを更新すると、オフラインモードでもアプリを使用できます。常に最新の情報を確認してください",
          btnText: "更新",
        },
        itemsList: {
          1: "予約",
      ...
      patientPage: {
        ...
        patientInfo: {
          ...
          deleteCard: {
            ...
            conscTwo:
              "この患者に関連するすべてのデータが損傷する可能性があります",
            conscThree:
              "この患者を使用して請求書や注文を作成することはできません",
            deleteBtn: "はい、削除",
          },
        },
      },
      ordonancePage: {
        ...
        stockCard: {
          ...
          infoCard: {
            ...
            alertTer:
              "この薬品は公共の薬品であるため、編集または削除することはできません。",
            deleteCard: {
              mainTitle: "この薬品を削除しますか？",
              alertText: "薬品を削除すると、",
              conscOne: "薬品は「薬品」の枝に表示されなくなります。",
              conscTwo:
                "この薬品に関連するすべてのデータが損傷する可能性があります。",
      ...
      teamPage: {
        ...
        teamInfoPage: {
          ...
          deleteCard: {
            ...
            conscTwo:
              "このメンバーに関連するすべてのデータが損傷する可能性があります",
            conscThree:
              "それ以外の場合、このメンバーで請求書や注文を行うことはできません",
            deleteBtn: "はい、削除",
          },
        },
      },
    ...
    TableHead: {
      ...
      reservation:
        "'*','ID','患者','経過した','ボリューム','時間','状態','登録済み?','表示'",
      menu: "'*','コード','名前','ジャンル','コスト','販売価格','X','表示'",
      stock: "'*','コード','名前','ジャンル','料金','表示'",
      camion:
        "'*','トラック','ナンバープレート','ドライバー','基金','収益','X','表示'",
      ...
      medicammentPage:
        "'*','コード','ジャンル','名前','投与量','形態','プレゼンテーション','クラス','表示'",
