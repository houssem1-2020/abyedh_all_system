  ...
  translation: {
    menusAndTabsName: {
      ...
      alternativeLink: {
        1: {
          title: "Assistant",
          descrip: "Interface Pour L\'assistant",
        },
        2: {
          title: "Calendrier",
    ...
    communUsed: {
      ...
      paymmentPage: {
        ...
        textOne:
          "Le paiement se fait par un virement a travers le Service Moneygram",
        textTwo: " vers le propritaire",
        textThree: "Telephone",
        afterFinishAlert:
          "Après avoir terminer le virement vous devez entrer les information ici : ",
      ...
      sysncroPage: {
        ...
        mainCard: {
          ...
          bottomText:
            "lorsque vous mettre a jour les données enregistré sur le serveur internet vous pourrait egalemment utiliser votre appplication en mode  Offline, soiyer toujour à jour",
      ...
      rdvPage:{
        ...
        rdvInfoCardData: {
          ...
          controlBtnCard : {
            ...
            addToCalendae:'Ajouter Aux Abonnemment',
            termineBtn:'Terminer',
      ...
      seancePage: {
        ...
        addSeanceInfo: {
          ...
          terminerTabsData: {
            ...
            pasGenre: {
              one: "Pas des Genres Enregistreé ",
              two: "Cliquer Ici",
              three: "Pour le faire ",
            },
            saveBtn: "Enregistrer",
      ...
      patientPage: {
        ...
        patientInfo: {
          ...
          deleteCard: {
            ...
            conscOne:
              'le Patient ne sera pas visible dans la branche "Patients"',
            conscTwo: "Tous les donneé relier a ce Patient peut s'endomager",
            conscThree:
              "vous ne pouver pas passer ni factures ni commandes avec ce Patients autremment",
        ...
        stockCard: {
          ...
          infoCard: {
            ...
            deleteCard: {
              ...
              conscOne:
                'le Medicamment ne sera pas visible dans la branche "Medicamments"',
              conscTwo:
                "Tous les donneé relier a ce Medicamment peut s'endomager",
              conscThree:
                "vous ne pouver pas passer ni factures ni commandes avec ce Medicamments autremment",
              deleteBtn: "Oui, Supprimer",
            },
          },
        },
      ...
      teamPage: {
        ...
        teamInfoPage: {
          ...
          deleteCard: {
            ...
            conscThree:
              "vous ne pouver pas passer ni factures ni commandes avec ce Membres autremment",
            deleteBtn: "Oui, Supprimer",
          },
        },
      },
    ...
    TableHead: {
      seance:
        "'*','ID','Patient','Maldaie','Degreé','Jour','Temps','Analyse','Ordonance','Voir'",
      seance:
        "'*','ID','Patient','Maldaie','Degreé','Jour','Temps','Analyse','Ordonance','Voir'",
      facture:
        "'*','ID','Caisse','Client','Jour','Temps','Totale','Etat','Voir'",
      ...
      reservation:
        "'*','ID','Patient', 'Passé le','Volu le','Temps','Etat','Enreg.?','Voir'",
      menu: "'*','Code', 'Nom', 'Genre','Cout','P.vente','X','Voir'",
      stock: "'*','Code', 'Nom', 'Genre','Tarif','Voir'",
      camion:
        "'*','Camion','Matricule', 'Chauffeur','Fond','Recette','X','Voir'",
      ...
      medicammentPage:
        "'*','Code','Genre','Nom', 'Dosage','Forme', 'Presentation','Classe','Voir'",
