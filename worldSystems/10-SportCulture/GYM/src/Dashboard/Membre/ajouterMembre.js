...
import { Button, Dropdown, Form, Icon, Input, Loader, Select, TextArea } from 'semantic-ui-react';
...
function AjouterClient() {
    ...
    const SaveClient = (event) => {
        ...
        else if (!clientD.Group_ID) {toast.error("Gouvernorat Invalide !", GConf.TostErrorGonf)}
            ...
            <Bounce left>
                <div className='row'>
                    <div className='col-12 col-lg-8'>
                        ...
                        <small>{grouListe.length == 0 ? <NavLink to='/S/gp'> Ajouter des groupes ici  </NavLink> : '' } </small>
                        <Dropdown
                                search
                                fluid
                                selection
