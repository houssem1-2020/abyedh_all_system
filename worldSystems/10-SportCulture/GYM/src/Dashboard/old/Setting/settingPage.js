        ...
        <>
          <div className="row mt-5">
            <div className="col-9 align-self-center">
              {" "}
              <h5>Activer Votre system ici </h5>
            </div>
            <div className="col-3">
      ...
      >
        <Modal.Content>
          <div className="text-center mt-5 mb-5">
            ...
            <NavLink to="/S/mu/famille">
              <h4>Cliquer Ici pour Informer l'administartion </h4>
            </NavLink>
          </div>
        </Modal.Content>
      </Modal>
