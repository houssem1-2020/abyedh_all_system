...
function UpdatePage() {
    ...
    const Genres = [
        {text: 'Souscription', allT: commandeList, whT: Offline.commande , whtTag :'commande' },
        {text: 'Seances', allT: stockList, whT: Offline.stock , whtTag :'stock' },
        {text: 'Abonnemment', allT: facturesList, whT: Offline.facture , whtTag :'facture' },
        {text: 'Equipemment', allT: camionList, whT: Offline.camion , whtTag :'camion' },
        {text: 'Memebres', allT: clientList, whT: Offline.client , whtTag :'client' },
        {text: 'Offres', allT: familleList, whT: Offline.famille , whtTag :'famille' },
    ]
    /*#########################[UseEffect]##################################*/
    useEffect(() => {
