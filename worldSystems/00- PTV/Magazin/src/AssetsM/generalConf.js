...
const GConf = {
    ...
    PID: GetPID(),
    Country : GetCountry(),
    ApiLink : 'https://api.abyedh.com/api/systems/magazin', //https://api.abyedh.com/api/systems/System 
    ApiRouterOneLink : 'https://api.abyedh.com/api/systems/magazin-caisse', //https://api.abyedh.com/api/systems/System 
    ApiRouterTwoLink : 'https://api.abyedh.com/api/systems/magazin-serveur', //https://api.abyedh.com/api/systems/System 
    ApiRouterThreeLink : 'https://api.abyedh.com/api/systems/magazin-chef', //https://api.abyedh.com/api/systems/System 
    ...
    SubSystemLink : [
        ...
        {id: 1, title:'Gerant', text:'Interface Pour le Gerant', icon:'pencil-square', link:'/R'},
    ],
