...
function AjouterCamion() {
    ...
    const [cassierListe, setCassierListe] = useState([]);
    ...
    useEffect(()=>{
        ...
        let testTable = []
        response.data.map( (getData) => testTable.push({key: getData.T_ID, value : getData.T_ID, text: getData.T_Name}))
        setCassierListe(testTable)
        })
    },[])
            ...
            <Bounce left>
                <div className='row'>
                    <div className='col-12 col-lg-8'>
                        ...
                        <div className='p-1  mb-2'>
                            <h5 className='mb-1'>Cassier : </h5>
                            <Select placeholder='Selectionner Un Cassier' fluid options={cassierListe} className='w-100 shadow-sm rounded mb-3' value={caisseD.Cassier_ID} onChange={(e, data) => setCaisseD({...caisseD, Cassier_ID: data.value })} />  
                        </div>
                        <div className='p-1 mb-2'>
