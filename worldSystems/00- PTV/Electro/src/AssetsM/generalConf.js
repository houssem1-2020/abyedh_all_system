...
const GConf = {
    ...
    ApiLink : 'https://api.abyedh.com/api/systems/electro', //https://api.abyedh.com/api/systems/System 
    ApiRouterOneLink : 'https://api.abyedh.com/api/systems/electro-caisse', //https://api.abyedh.com/api/systems/System 
    ApiRouterTwoLink : 'https://api.abyedh.com/api/systems/electro-serveur', //https://api.abyedh.com/api/systems/System 
    ApiRouterThreeLink : 'https://api.abyedh.com/api/systems/electro-chef', //https://api.abyedh.com/api/systems/System 
