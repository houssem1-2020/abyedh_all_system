...
function TeamInfo() {
        ...
        const panes = [
            {
                menuItem: { key: 'test', icon: 'file text', content: 'Generale' }, 
                render: () =><Tab.Pane className='border-div mb-4' attached={false}><GeneralCard /> </Tab.Pane> ,
            },
            // {
            // menuItem: { key: 'fffgg', icon: 'file text', content: 'Presence' }, 
            // render: () =><Tab.Pane className='border-div mb-4' attached={false}><PresenceCard /> </Tab.Pane> ,
            // },
            {
