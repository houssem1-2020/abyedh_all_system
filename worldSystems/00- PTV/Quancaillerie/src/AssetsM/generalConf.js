...
const GConf = {
    ...
    // main variables
    PID: GetPID(),
    ApiLink : 'https://api.abyedh.com/api/systems/quancaillerie', //https://api.abyedh.com/api/systems/System 
    ApiRouterOneLink : 'https://api.abyedh.com/api/systems/quancaillerie-caisse', //https://api.abyedh.com/api/systems/System 
    ApiRouterTwoLink : 'https://api.abyedh.com/api/systems/quancaillerie-serveur', //https://api.abyedh.com/api/systems/System 
    ApiRouterThreeLink : 'https://api.abyedh.com/api/systems/quancaillerie-chef', //https://api.abyedh.com/api/systems/System 
    DefaultTva: 0,
    themeColor : '#406163',
