...
const GConf = {
    ...
    ApiLink : 'https://api.abyedh.com/api/systems/boutique', //https://api.abyedh.com/api/systems/System 
    ApiRouterOneLink : 'https://api.abyedh.com/api/systems/boutique-caisse', //https://api.abyedh.com/api/systems/System 
    ApiRouterTwoLink : 'https://api.abyedh.com/api/systems/boutique-serveur', //https://api.abyedh.com/api/systems/System 
    ApiRouterThreeLink : 'https://api.abyedh.com/api/systems/boutique-chef', //https://api.abyedh.com/api/systems/System 
