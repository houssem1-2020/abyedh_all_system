...
const EditFSCard = ({fournisseurData, setFSData, EditClient,delegList,GetDelegList,loaderState}) =>{
    ...
    useEffect(() => {
        setFSData({...fournisseurData, Four_Gouv: fournisseurData.Four_Gouv })
        setFSData({...fournisseurData, Articles_Genre: fournisseurData.Articles_Genre })
        setFSData({...fournisseurData, Jour_Periodique: fournisseurData.Jour_Periodique })
        GetDelegList(fournisseurData.Four_Gouv)
    },[])
    ...
    return(<>
            <div className='p-1'>
                        <div className='p-1 mb-2'>
                            ...
                            <Input icon='key' iconPosition='left'  placeholder='Matricule Fiscale' className='w-100 border-0 shadow-sm rounded mb-1'   value={fournisseurData.Four_Code_Fiscale}  onChange={(e) => setFSData({...fournisseurData, Four_Code_Fiscale: e.target.value })}/>
                        </div>
                        <div className='p-1  mb-2'>
                        ...
                        <div className='p-1 mb-2'>
                            ...
                            <Select placeholder='Choisir Une Region' options={familles} value={fournisseurData.Articles_Genre} className='w-100 shadow-sm rounded mb-3' onChange={(e, data) => setFSData({...fournisseurData, Articles_Genre: data.value })} />
                        </div>
                        <div className='p-1 mb-2'>
                        ...
                        <div className='p-1 mb-2'>
                            ...
                            <Select placeholder='Choisir Une Region' options={jourPeriodique}  value={fournisseurData.Jour_Periodique} className='w-100 shadow-sm rounded mb-3' onChange={(e, data) => setFSData({...fournisseurData, Jour_Periodique: data.value })} />  
...
function FournisseurInfo() {
         ...
         useEffect(() => {
             ...
             axios.post(`${GConf.ApiLink}/fournisseur/info`, {
                ...
                console.log(response.data)
                 if(!response.data.Data.PK) {
                     ...
                     setPosition([response.data.Data.Four_Lat, response.data.Data.Four_Lng])
                     setLoading(true)
          ...
          /* ############################### Functions ################################*/
            ...
            const EditClient = () =>{
                if (!fournisseurData.Four_Code_Fiscale) {toast.error("Matricule Invalide !", GConf.TostErrorGonf)}
                     ...
                     <div className='card card-body shadow-sm mb-2 border-div'>
                         ...
                         <div className="img-card-container text-center">
                             <div className="card-container">
                                 <img src="https://cdn.abyedh.com/images/system/Magazin/camion.jpg" className="rounded-circle" width="80" />                    
                             </div>
                         </div>
