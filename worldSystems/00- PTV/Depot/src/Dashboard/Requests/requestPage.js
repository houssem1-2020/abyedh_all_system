    ...
    const panesRes = [
      {
        ...
        render: () => <TableGrid tableData={FetchByGenreReserv('W')} columns={GConf.TableHead.request} />,
      },
      {
        menuItem: { key: 'attent',  content: <span className='text-warning'><b><span className='bi bi-hourglass-split'></span> En Attent</b></span> , className:'rounded-pill'},
        render: () => <TableGrid tableData={FetchByGenreReserv('S')} columns={GConf.TableHead.request} />,
      },
      {
        ...
        render: () => <TableGrid tableData={FetchByGenreReserv('A')} columns={GConf.TableHead.request} />,
      },
      {
        ...
        render: () => <TableGrid tableData={FetchByGenreReserv('R')} columns={GConf.TableHead.request} />,
      },
      {
        menuItem: { key: 'refuse',  content: <span className='text-danger'><b><span className='bi bi-x-square-fill'></span> Refuseé</b></span>, className:'rounded-pill' },
        render: () => <TableGrid tableData={FetchByGenreReserv('F')} columns={GConf.TableHead.request} />,
      },
    ]
