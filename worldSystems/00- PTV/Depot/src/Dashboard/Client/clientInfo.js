...
function ClientInfo() {
    ...
    const panes = [
        {
            menuItem: { key: 'home', icon: 'file alternate outline', content: 'Factures' }, 
        ...
        {
            menuItem: { key: 'Reservation', icon: 'truck', content: 'F. Camion' }, 
    ...
    useEffect(() => {
        ...
        axios.post(`${GConf.ApiLink}/client/info`, {
            ...
            if(!response.data.Data.PK) {
                ...
                response.data.FactureCamion.map( (getData, index) => reservationTable.push([ 
                    getData.R_ID,
                    response.data.Data.CL_Name,
                    new Date(getData.R_Date).toLocaleDateString('fr-FR').split( '/' ).reverse( ).join( '-' ),
                    getData.Table_Num,
                ...
                <div className='card card-body shadow-sm mb-2 border-div'>
                    ...
                    <div className="img-card-container text-center">
                        <div className="card-container">
                            <img src="https://cdn.abyedh.com/images/system/shared/client.png" className="rounded-circle" width="80" />                    
                        </div>
                    </div>
