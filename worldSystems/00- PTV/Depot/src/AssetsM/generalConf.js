...
const GConf = {
    ...
    // main variables
    PID: GetPID(),
    ApiLink : 'https://api.abyedh.com/api/systems/depot', //https://api.abyedh.com/api/systems/System 
    ApiRouterOneLink : 'https://api.abyedh.com/api/systems/depoti', //https://api.abyedh.com/api/systems/System 
    ApiRouterTwoLink : 'https://api.abyedh.com/api/systems/depoti', //https://api.abyedh.com/api/systems/System 
    ApiRouterThreeLink : 'https://api.abyedh.com/api/systems/depoti', //https://api.abyedh.com/api/systems/System 
    DefaultTva: 0,
    themeColor : '#6f858f',
    ...
    //Subsystems
    SubSystemLink : [
        {id: 3, title:'Camions', text:'Interface Pour La Caisse', icon:'truck', link:'/C'},
        {id: 1, title:'Commerciale', text:'Interface Pour Passer Des Commandes', icon:'receipt-cutoff', link:'/R'},
    ],
    ...
    //main stat card
    LinkCard: [
        { id: 1, col: 3 , tag:"articles", dataTag:'articlesNum',  icon: 'upc-scan', link:'sk/ajouter', smallT: 'Article', desc: 'Nouveaux Article' , stat:'22452'},
        { id: 2, col: 3 , tag:"factures", dataTag:'facturesNum', icon: 'receipt-cutoff', link:'ft/ajouter', smallT: 'Factures', desc: 'Ajouter Facture' , stat:'22452'},
        { id: 3, col: 3 , tag:"clients", dataTag:'clientsNum', icon: 'person', link:'cl/ajouter', smallT: 'Clients', desc: 'Ajouter Clients' , stat:'1235'},
    ...
    BreadCrumb:{
        ...
        ClientStat: [
            {id:1, name:'Client', linkable:true, link:"/S/cl"},
            {id:2, name:'Statistique', linkable:false}
        ],
        ClientRegion: [
            {id:1, name:'Client', linkable:true, link:"/S/cl"},
        ...
        FournisseurAdd: [
            ...
            {id:2, name:'Recherche', linkable:false}
        ],
        FournisseurCalendar: [
            {id:1, name:'Fournisseur', linkable:true, link:"/S/fs"},
            {id:2, name:'Calendrier', linkable:false}
