    ...
    const MainTopCard = () =>{
        return(<>
             <div className={`card p-3 fixed-top border-0 shadow-sm rounded-0 ${OneGConf.themeMode == 'dark' ? 'bg-dark-theme-1' : '' }`}>
                <div className='row'>
                    <div className='col-8 col-lg-8 align-self-center'><h2> <span className="badge bg-info"> <span className='bi bi-pc-display-horizontal '></span>  {OneGConf.forPID.Cam_Name} </span></h2></div>
 
                    <div className='col-lg-1 d-none d-lg-block align-self-center' >
            ...
            <div className={`${OneGConf.themeMode == 'dark' ? 'bg-dark-theme-2' : '' }`} style={{height: '100vh', overflow: 'scroll'}}>
                ...
                <Fade >            
                    <div className='container '>
                        ...
                        <hr />
                        <div className='row'>
                            <div className='col-6 mb-3'> <LinkCard data={OneGConf.main[6]} /> </div>
                            <div className='col-6 mb-3'> <LinkCard data={OneGConf.main[7]} /> </div>
                        </div>
                    </div>
                </Fade>  
            </div>
