    ...
    translation : {
        menusAndTabsName:{
            ...
            alternativeLink :{
              1 :{
                title:'Встреча',
                descrip:'Интерфейс для управления встречами'
              },
              2 :{
                title:'Календарь',
        ...
        communUsed:{
            ...
            settingPage: {
              ...
              confirmerCard: {
                ...
                nonConfirmerText: 'Ваш аккаунт не подтвержден на сайте abyedh.tn',
        ...
        alternativeS: {
            rdvPortail: {
                loginInPage: {
                    connextionText: 'Подключение:',
                    identifiant: 'Идентификация',
                    pwd: 'Пароль',
                    smartId: 'Введите Smart ID',
                    connBtn: 'Подключение',
                    validBtn: 'Введите Smart ID'
                },
                mainPage: {
                    cl: 'ПАЦИЕНТЫ',
                    rdv: 'ВСТРЕЧИ',
