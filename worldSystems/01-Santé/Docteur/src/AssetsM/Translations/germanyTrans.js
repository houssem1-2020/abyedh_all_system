const GermanyTrans = {
    translation : {
        menusAndTabsName:{
            ...
            alternativeLink :{
              1 :{
                ...
                descrip:'Schnittstelle zur Verwaltung von Terminvereinbarungen'
              },
              2 :{
                title:'Kalender',
        ...
        communUsed:{
            ...
            settingPage:{
              ...
              confirmerCard:{
                ...
                nonConfirmerText:'Ihr Konto ist auf abyedh.tn nicht bestätigt',
        ...
        alternativeS: {
            rdvPortail: {
                loginInPage: {
                    connextionText: 'Verbindung:',
                    identifiant: 'Identifikation',
                    pwd: 'Passwort',
                    smartId: 'Smart-ID eingeben',
                    connBtn: 'Verbindung',
                    validBtn: 'Smart-ID eingeben'
                },
                mainPage: {
                    cl: 'PATIENTEN',
                    rdv: 'TERMINE',
