...
const TerminerCard = ({rapportData, setRapportData,allClientList, OnKeyPressFunc}) =>{
    ...
    const rapportGenre = [
        {value : 'Medicale Gébérale', text : t('menuTabs.rapportPage.addRapport.terminerCard.genreListe.1') , key: 1},
        {value : 'Hospitalisation', text : t('menuTabs.rapportPage.addRapport.terminerCard.genreListe.2'), key: 2},
        {value : 'Urgence', text : t('menuTabs.rapportPage.addRapport.terminerCard.genreListe.3'), key: 3},
        {value : 'Consultation', text : t('menuTabs.rapportPage.addRapport.terminerCard.genreListe.4'), key: 4},
        {value : 'Evaluation', text : t('menuTabs.rapportPage.addRapport.terminerCard.genreListe.5'), key: 5},
        {value : 'Diagnostique', text : t('menuTabs.rapportPage.addRapport.terminerCard.genreListe.6'), key: 6},
        {value : 'Suivie', text : t('menuTabs.rapportPage.addRapport.terminerCard.genreListe.7'), key: 7},
        {value : 'Recherche Medicale', text : t('menuTabs.rapportPage.addRapport.terminerCard.genreListe.8'), key: 8},
        {value : 'Cas Clinique', text : t('menuTabs.rapportPage.addRapport.terminerCard.genreListe.9'), key: 9},
        {value : 'Medico-Légale', text : t('menuTabs.rapportPage.addRapport.terminerCard.genreListe.10'), key: 10},
        {value : 'Autopsie', text : t('menuTabs.rapportPage.addRapport.terminerCard.genreListe.11'), key: 11},
        {value : 'Sante Publique', text : t('menuTabs.rapportPage.addRapport.terminerCard.genreListe.12'), key: 12},
        {value : 'Autre', text : t('menuTabs.rapportPage.addRapport.terminerCard.genreListe.13'), key: 13},
    ]
    return (<>
             
            <h5 className='mb-1 mt-1'> {t('menuTabs.rapportPage.addRapport.terminerCard.Titre')}  </h5>
            <Input icon='text height' onKeyPress={event => OnKeyPressFunc(event)} list="clientList" placeholder={t('menuTabs.rapportPage.addRapport.terminerCard.Titre')} value={rapportData.RA_Titre}  onChange={ (e) => setRapportData({...rapportData, RA_Titre: e.target.value })} size="small" iconPosition='left'   fluid className='mb-1' />

            <h5 className='mb-1 mt-1'> {t('menuTabs.rapportPage.addRapport.terminerCard.Sujet')} </h5>
            <Form>
                <TextArea rows={2} placeholder={t('menuTabs.rapportPage.addRapport.terminerCard.Sujet')} onKeyPress={event => OnKeyPressFunc(event)} value={rapportData.RA_Sujet} onChange={(e) => setRapportData({...rapportData, RA_Sujet : e.target.value })} />
            </Form>

            <h5 className='mb-1 mt-1'> {t('menuTabs.rapportPage.addRapport.terminerCard.Date')}   </h5>
            ...
            <h5 className='mb-1 mt-1'> {t('menuTabs.rapportPage.addRapport.terminerCard.Genre')}  </h5>
            <Dropdown
                fluid
                search
                selection
...
function AjouterFacture() {
    ...
    const panes = [
        {
            menuItem: { key: 'start', icon: 'add circle', content:  t('menuTabs.rapportPage.addRapport.tabsText.contenue') }, 
            render: () => <DiagnostiqueCard />,
        },
         
        {
            menuItem: { key: 'articles', icon: 'save', content:   t('menuTabs.rapportPage.addRapport.tabsText.terminer') }, 
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-12  '>
                                            ...
                                            <div className='row mb-2'>
                                                <div className='col-12'>
                                                    <Button  className='rounded-pill bg-system-btn' disabled={saveBtnState} fluid onClick={SaveRapport}><Icon name='save' /> {t('menuTabs.rapportPage.addRapport.terminerCard.saveBtn')} <Loader inverted active={loaderState} inline size='tiny' className='ms-2'/></Button>
                                                </div>
                                            </div>
                                            <div className='row mb-2'>
                                                <div className='col-12'>
                                                    <Button  className='rounded-pill btn-imprimer' disabled={!saveBtnState} fluid onClick={(e) => PrintFunction('printRapport')}><Icon name='print' /> {t('menuTabs.rapportPage.addRapport.terminerCard.printBtn')} </Button>
                                                </div>
                                            </div>
   ...
   /*#########################[Card]##################################*/
        ...
        return (<>
                <div className='  card-body   mb-4'  >
                    ...
                    <Editor
                        ...
                        height = '500px' 
                        placeholder={t('menuTabs.rapportPage.addRapport.rptPlch')}
    ...
    return (<>
        <BreadCrumb links={GConf.BreadCrumb.factureEdit} bcTag='factureEdit' />
        <br />
