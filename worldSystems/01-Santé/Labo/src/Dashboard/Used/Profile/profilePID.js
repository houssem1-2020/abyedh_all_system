...
import dirItem from '../../../AssetsM/generalConf'
...
function ProfilePID() {
    ...
    useEffect(() => {
        setPageSize();
        axios.post(`${GConf.SharedApi}/profile/print`, {
            PID: GConf.PID,
        ...
        <div className='row'> 
                ...
                <div className='card card-body border-div border-0'>
                    <div className='row'>
                        ...
                        <div className='col-10'>
                                ...
                                <div className='row'>
                                    <div className='col-11'><span className='bi bi-lock-fill text-success bg-gray rounded-pill me-3 ms-1'></span> https://abyedh.com/</div>
                    ...
                    <h1 className='text-center' style={{color: GConf.themeColor}}>{GConf.systemTag}</h1>
                    <br />
                    
                    <div className='row'>
                        <div className='col-12 text-center'>
                            <QRCode fgColor={'GConf.themeColor'} value={`${GConf.systemTag}/${GConf.PID}`} size={350} />
                            <br />
                        </div>
                    </div>
                    <br />
                    <ul>
                        <li>Télecharger L'app  <b>abyedh.com : PWA</b> ou Naviguer Sur : <b>https://abyedh.com/</b> </li>
            ...
            <div className='col-6'>
                <div className=' text-center mt-4 '>
                    <QRCode fgColor={GConf.themeColor} value={GConf.systemTag} size={450} />
                    ...
                    <div className='row'>
                            <div className='col-2 align-self-center text-end'><img src="https://cdn.abyedh.com/images/logo/logo-app-store.jpg" className="img-responsive  mb-2" style={{width:'80px'}}  /></div>
                                <div className='col-8 text-start'> 
                                    <h5 className='mb-1'>abyedh.com : PWA</h5>
