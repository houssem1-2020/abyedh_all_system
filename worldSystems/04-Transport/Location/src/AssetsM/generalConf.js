...
const GConf = {
    ...
    PID: GetPID(),
    Country : GetCountry(),
    localApi : 'http://localhost:3311/systems/location', //https://api.abyedh.com/api/systems/System 
    ApiLink : 'https://api.abyedh.com/api/systems/location', //https://api.abyedh.com/api/systems/System 
    ApiRouterOneLink : 'https://api.abyedh.com/api/systems/location-rdv', //https://api.abyedh.com/api/systems/System 
    ApiRouterTwoLink : 'https://api.abyedh.com/api/systems/location-serveur', //https://api.abyedh.com/api/systems/System 
    ApiRouterThreeLink : 'https://api.abyedh.com/api/systems/location-chef', //https://api.abyedh.com/api/systems/System 
    ...
    NavsData : [
            ...
            {id:3, name:"Reservations", icon:"calendar-week", link:"rs"},
            {id:4, name:"Client", icon:"receipt-cutoff", link:"cl"},
