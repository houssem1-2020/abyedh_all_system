...
const GConf = {
    ...
    PID: GetPID(),
    Country : GetCountry(),
    ApiLink : 'https://api.abyedh.com/api/systems/transporteur', //https://api.abyedh.com/api/systems/System 
    ApiRouterOneLink : 'https://api.abyedh.com/api/systems/transporteur-camion', //https://api.abyedh.com/api/systems/System 
    ApiRouterTwoLink : 'https://api.abyedh.com/api/systems/transporteur-serveur', //https://api.abyedh.com/api/systems/System 
    ApiRouterThreeLink : 'https://api.abyedh.com/api/systems/transporteur-chef', //https://api.abyedh.com/api/systems/System 
    ...
    NavsData : [
            ...
            {id:3, name:"Operations", icon:"upc-scan", link:"op"},
            {id:5, name:"Stock", icon:"box-seam", link:"sk"},
            {id:6, name:"Camions", icon:"truck", link:"cm"},
            {id:7, name:"Clients", icon:"people", link:"cl"},
    ...
    LinkCard: [
        ...
        { id: 2, col: 2 , tag:"facture", dataTag:'abonnementNum', icon: 'receipt-cutoff', link:'ab/resumer', smallT: 'Operation', desc: 'Resumer', isFloat : false , stat:'22452'},
        { id: 3, col: 2 , tag:"client", dataTag:'membreNum', icon: 'person', link:'mb/ajouter', smallT: 'Client', desc: 'Ajouter', isFloat : false , stat:'1235'},
        { id: 4, col: 2 , tag:"caisse", dataTag:'equipemmentNum', icon: 'truck', link:'eq/ajouter', smallT: 'Camion', desc: 'Inventaire', isFloat : false , stat:'22'},
    ...
    BreadCrumb:{
        ...
        menuAddPlat: [
            {id:1, name:'Abonnemment', linkable:true, link:"/S/cm"},
    ...
    SubNavs: {
        ...
        Menu: [
            {id:1,  icon: 'bookmark-plus', text: 'Nouveaux Camion', link: 'ajouter', dropD: false},
            {id:2, icon: 'tags', text: 'Map', link: 'map', dropD: false },
        ...
        facture: [
            {id:1,  icon: 'receipt', text: 'Nouveaux Operation', link: 'ajouter', dropD: false},
            {id:2,  icon: 'file-earmark-medical-fill', text: 'Resumer', link: 'resumer', dropD: false},
            {id:3,  icon: 'calendar-week', text: 'Calendrier', link: 'calendar', dropD: false},
        ],
        client: [
    ...
    //TableHead
    TableHead:{
        abonnemment:['*','ID','Client','Camion','Date','De','Vers', 'Totale','Etat','Voir'],
        seances:['*','ID','Caisse','Client','Jour','Temps','Etat','Voir'],
        request:['*','ID','Client', 'Date','Table','Etat','X','Voir'],
        reservation:['*','ID','Nom', 'Age','Genre','Age','Genre', 'Depart','X','Voir'],
        menu:['*','Code', 'Nom', 'Qte','Genre','Description' ,'Voir'],
        Offre:['*','Code', 'Nom', 'Poid Max','Tarif','Tarif Fix','Voir'],
        classes:['*','ID', 'Nom', 'Matricule','Chauffeur','Genre','Voir'],
