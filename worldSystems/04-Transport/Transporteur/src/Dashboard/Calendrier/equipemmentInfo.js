...
function PlatInfo() {
    ...
    const options = [
        { key: '1', value: '001.png', text: 'Les bancs de musculation', image: { src: 'https://cdn.abyedh.com/images/system/gym/001.png', avatar: true } },
        { key: '2', value: '002.png', text: 'Les équipements de suspension ', image: { src: 'https://cdn.abyedh.com/images/system/gym/002.png', avatar: true } },
        { key: '3', value: '003.jpg', text: 'Les machines cardiovasculaires', image: { src: 'https://cdn.abyedh.com/images/system/gym/003.jpg', avatar: true } },
        { key: '4', value: '004.png', text: 'Les équipements de cardio-training', image: { src: 'https://cdn.abyedh.com/images/system/gym/004.png', avatar: true } },
        { key: '5', value: '005.png', text: 'Les poids libres', image: { src: 'https://cdn.abyedh.com/images/system/gym/005.png', avatar: true } },
        { key: '6', value: '006.jpg', text: 'Les tapis d exercice', image: { src: 'https://cdn.abyedh.com/images/system/gym/006.jpg', avatar: true } },
      ]
                ...
                <div className='card card-body shadow-sm mb-2 border-div'>
                    ...
                    <div className="img-card-container text-center">
                        <div className="card-container notification">
                            <img src={`https://cdn.abyedh.com/images/system/gym/${equipemmentD.Photo_Path}`} className="rounded-circle bg-white" width="80px" height="80px" />                    
                        </div>
                    </div>
        ...
        <div className='row p-2 mb-2'>   
             ...
             <div className='col-4'> 
                    <div className='card card-body  text-center p-4 mb-2 border-3 img-container'>
                        <img src={`https://cdn.abyedh.com/images/system/gym/${equipemmentD.Photo_Path}`} width='100%' height='150px'  /> 
                    </div>
