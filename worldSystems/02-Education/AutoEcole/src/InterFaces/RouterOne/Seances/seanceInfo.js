    ...
    const DeleteSeance = () =>{
                ...
                .then(function (response) {
                    if(response.status = 200) {
                        ...
                        setTimeout(() => {  window.location.href = `/${OneGConf.routerName}/L/ms/`; }, 2000)
                    }
                    else{
   ...
   /*#########################[Card]##################################*/
        ...
        return(<>
                <div className='card card-body shadow-sm mb-2 border-div'>
                    ...
                    <div className='col-12'>
                            <Button as='a' onClick={ (e) => NavigateFunction(`/${OneGConf.routerName}/L/ms/edit/${SID}`)}  animated   className='rounded-pill bg-system-btn mb-3'  fluid>
    ...
    return (<>
        ...
        <div className={`${OneGConf.themeMode == 'dark' ? 'bg-dark-theme-2' : '' }`} style={{height: '100vh', overflow: 'scroll'}}>
            <BackCard data={OneGConf.backCard.saInfo}/>
            <br />
            <div className='container'>
                <div className='row'>
