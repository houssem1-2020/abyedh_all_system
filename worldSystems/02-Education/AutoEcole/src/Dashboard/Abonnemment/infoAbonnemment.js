    ...
    useEffect(() => {
            ...
            .then(function (response) {
                    if(response.data.Data.length == 0) {
                        ...
                        let SeanceL = []
                        response.data.Seances.map( (Seance) => SeanceL.push( { title: Seance.SE_Time, date: Seance.SE_Date , className:'bg-warning border-0  text-center', url: `/S/sa/info/${Seance.SE_ID}`}))
