...
function ResumerFactures() {
    ...
    const FetchTargetFactures = () =>{
        ...
        .then(function (response) {
            ...
            getData.AB_Genre,
            getData.Tarif,
            //_(<div className ='badge p-1 bg-info'>{moment(getData.AB_Depart_Date, "YYYYMMDD").fromNow() }</div>),
    ...
    return ( <>
        ...
        <div className='row'>
            ...
            <div className='col-12 col-lg-9'>
                <TableGrid tableData={factureList} columns={['*','ID','Condidat','Forfait','Depart','Genres','Seances','Etat','Voir']} />                        
            </div>
        </div>
