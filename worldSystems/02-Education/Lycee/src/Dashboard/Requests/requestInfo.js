...
function RequestInfo() {
    ...
    /*#########################[useEffect]##################################*/ 
    useEffect(() => {
        axios.post(`${GConf.ApiLink}/inscription/info`, {
            PID : GConf.PID,
            CID: CID
          })
    ...
    const StateCard = ({ status }) => {
        ...
        const statusCard = React.useCallback(() => {
          switch(status) {
            ...
            case 'IN': return <StateCard color='rederecter' text={t(`menuTabs.rdvPage.tabsTtems.incomplet`)} />;
                ...
                <div className='card card-body shadow-sm mb-2 border-div'>
                    ...
                    <div className='row '>
                        ...
                        <div className='col-12 mb-2'>
                            <Button  className={`rounded-pill ${reqState == 'IN' ? 'bg-rederecter text-white' : 'bg-gray text-rederecter'}`}  fluid onClick={ () => UpdateRequestState('IN',false,false,true,false) }><Icon name='delete calendar' /> {t('menuTabs.rdvPage.rdvInfoCardData.controlBtnCard.incopmlete')} </Button>
                        </div>
                        {/* <div className='col-6 mb-2'>
