...
function TeamPage() {
    ...
    axios.post(`${GConf.ApiLink}/team`, {
        ...
        getData.Poste,
        _(getData.Is_Prof ? <span className='badge bg-success'>Oui</span> : <span className='badge bg-danger'> Non </span>),
        ...
        <>
            <Fade>
                <div className='row'>
                    ...
                    <div className='col-12 col-lg-4 text-end align-self-center'><MainSubNavCard text='Interface RDV' link='../C' icon='window-dock' />  </div>
                </div>
                <br />
