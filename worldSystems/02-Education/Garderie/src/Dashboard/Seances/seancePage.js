...
function FacturePage() {
    ...
    return (<>
        <Fade>
            ...
            <div className='row'>
                <div className='col-12 col-lg-8'><SubNav dataForNav={GConf.SubNavs.seances}/></div>
                <div className='col-12 col-lg-4 text-end align-self-center'><MainSubNavCard text='Salles' link='sl' icon='box-seam-fill' />   </div>
            </div>
