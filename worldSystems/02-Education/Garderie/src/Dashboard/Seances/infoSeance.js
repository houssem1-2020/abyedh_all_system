...
function FactureInfo() {
   ...
   /*#########################[Card]##################################*/
    ...
    const BtnsCard = () =>{
        return(<>
                <div className='card card-body shadow-sm mb-2'>
                    ...
                    <div className='col-6'>
                            <Button as='a' href={`/S/sa/modifier/${SID}`} animated   className='rounded-pill bg-system-btn'  fluid>
    ...
    return (<>
        ...
        {/* <FrameForPrint frameId='printFacture' src={`/Pr/facture/info/${gettedOrSID}`} /> */}
    </> );
    }
