...
function DataBaseBU() {
    ...
    let exportedTable = [
        ...
        { name: '06_gym_abonnement_seances', where: `PID = ${GConf.PID}`, toExport : true},
        ...
        { name: '06_gym_membres_group', where: `PID = ${GConf.PID}`, toExport : true},
    ...
    const StockCard = () =>{
        return(<>
            <div className='card card-body shadow-sm mb-4 border-div'>
               ...
               <Checkbox className='mb-2' label='Sauvgarder le seances' defaultChecked  onChange={(event, data) =>  UpdateTableStet('05_restaurant_menu',data.checked)}/>
               <Checkbox className='mb-2' label='Sauvgarder les offres' defaultChecked  onChange={(event, data) =>  UpdateTableStet('05_restaurant_menu_genre',data.checked)}/>
               <Checkbox className='mb-2' label='Sauvgarder les abonnemment ' defaultChecked onChange={(event, data) =>  UpdateTableStet('05_restaurant_factures',data.checked)} />
               <Checkbox className='mb-2' label='Sauvgarder les equipemment ' defaultChecked onChange={(event, data) =>  UpdateTableStet('05_restaurant_caisses',data.checked)} />
               <Checkbox className='mb-2' label='Sauvgarder les membres ' defaultChecked onChange={(event, data) =>  UpdateTableStet('05_restaurant_clients',data.checked)} />
               ...
               <Checkbox className='mb-2' label='Sauvgarder les Groupes ' defaultChecked onChange={(event, data) =>  UpdateTableStet('05_restaurant_tables',data.checked)} />
