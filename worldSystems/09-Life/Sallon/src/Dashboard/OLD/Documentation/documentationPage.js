            ...
            <div className='row'>
                <div className='col-12 col-lg-3'>
                    <div className="sticky-top" style={{top:'70px'}}>
                            <MenuItemCard text='Souscription' icon='calendar2-check' activeI={0} />
                            <MenuItemCard text='Abonnemment' icon='receipt-cutoff' activeI={1} />
                            <MenuItemCard text='Seances' icon='pc-display-horizontal' activeI={2} />
                            <MenuItemCard text='Equipemment' icon='receipt-cutoff' activeI={3} />
