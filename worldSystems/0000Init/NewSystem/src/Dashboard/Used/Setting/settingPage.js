...
function SettingPage() {
    ...
    const UpdateNotifToken = (genre,token) => {
        if (genre == 'remove'  ) {
            setLS(true)
            axios.post(`${GConf.ApiLink}/parametre/update/notif-token`, {
                PID : GConf.PID,
                Token : '',
            }).then(function (response) {
                ...
                <div className="row justify-content-center">
                    <div className="col-12 col-lg-5">
                        <div className='sticky-top' style={{top:'80px'}}>
                            <h5> {t('communUsed.settingPage.title')}</h5>        
                                    ...
                                    <div className="col-11 align-self-center text-left">
                                        <div className="d-flex">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                ...
                                                <b>Language</b>
                                                <br />
                                                <small className="text-secondary">{t(`communUsed.settingPage.settingCard.1.desc`)}</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-1 align-self-center"><span className="bi bi-arrow-right-short bi-md"></span></div>
                            ...
                            {/* <div className="list-group-item list-group-item-action" onClick={() => OpenBottomSheetFunction('general')}>
                                <div className="row p-2">
                                    <div className="col-11 align-self-center text-left">
                                        <div className="d-flex">
                                            <div className="flex-shrink-0">
                                                <div className='rounded-circle text-secondary m-0'  style={{width:45 , height:45, backgroundColor: 'white' , textAlign:'center', paddingTop:'25%'}}><span className={`bi bi-calendar3 bi-sm`} ></span></div>
                                            </div>
                                            <div className="flex-grow-1 ms-3">
                            ...
                            <div className="list-group-item list-group-item-action" onClick={() => OpenBottomSheetFunction('general')}>
                                <div className="row p-2">
                                    <div className="col-11 align-self-center text-left">
                                        <div className="d-flex">
                                            <div className="flex-shrink-0">
                                                <div className='rounded-circle text-secondary m-0'  style={{width:45 , height:45, backgroundColor: 'white' , textAlign:'center', paddingTop:'25%'}}><span className={`bi bi-star bi-sm`} ></span></div>
                                            </div>
                                            <div className="flex-grow-1 ms-3">
                                                <b>{t(`communUsed.profilePage.menuTabList.avisShow`)}</b>
                                                <br />
