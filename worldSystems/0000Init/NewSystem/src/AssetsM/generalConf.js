...
const GConf = {
    ...
    PID: GetPID(),
    Country : GetCountry(),
    localApi : 'http://localhost:3311/systems/docteur', //https://api.abyedh.com/api/systems/System 
    ApiLink : 'https://api.abyedh.com/api/systems/docteur', //https://api.abyedh.com/api/systems/System 
    ApiRouterOneLink : 'https://api.abyedh.com/api/systems/docteur-rdv', //https://api.abyedh.com/api/systems/System 
    ApiRouterTwoLink : 'https://api.abyedh.com/api/systems/docteur-serveur', //https://api.abyedh.com/api/systems/System 
    ApiRouterThreeLink : 'https://api.abyedh.com/api/systems/docteur-chef', //https://api.abyedh.com/api/systems/System 
