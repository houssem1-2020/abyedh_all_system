    ...
    return(<>
        {/* <div className='card card-body shadow-sm border-div mb-3'> */}
                ...
                <div className='row'>
                    ...
                    <div className='col-12 col-lg-6 d-none d-lg-flex align-self-center'><img src={`https://cdn.abyedh.com/Images/ads/${targetSystem.adsImageUrl}`} className='img-responsive ' width='100%' height='200px'/></div>
                </div>
        ...
        <div className='container font-droid' dir="rtl">
            <div className='row justify-content-center mb-4'>
                <div className='col-12 col-lg-9'>
                        ...
                        <br />
                        <h6 className='text-secondary font-hs-n me-5 mb-2'> 1- إمتلاك حساب في منصة أبيض  (<a href='https://abyedh.com/' target='c_blank' >abyedh.com</a>) </h6> 
