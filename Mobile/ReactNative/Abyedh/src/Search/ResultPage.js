...
const ResultPage = () => {
  ...
  const ResultCard = (props) => {
    ...
    return (
        <TouchableOpacity style={{ flex: 1 , borderColor: '#e3e3e3', borderWidth:1, borderRadius:12, marginBottom: 7, padding:11, flexDirection:'row'}} onPress={ () => navigation.navigate('ProfilePage', {Tag:Tag, PID: props.data.PID})} >
