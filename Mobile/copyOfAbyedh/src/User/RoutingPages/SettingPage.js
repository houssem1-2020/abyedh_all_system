  ...
  return (
    <SafeAreaProvider>
      <SafeAreaView style={{ flex: 1, paddingTop: 15}} >
        ...
        <TouchableOpacity onPress={() => refRBSheet.current.open()} style={{ alignItems:'center', marginTop:20,  justifyContent:'center', borderWidth:1, borderRadius : 12, borderColor:'#dfdfdf', padding: 13 , marginBottom: 0,  borderBottomColor:'#dfdfdf',   }}>  
                <View style={{ flex: 9, alignItems: isRTL ? 'flex-end' : 'flex-start', justifyContent: 'center' }}>
                    <Text style={{ color: 'grey',  fontFamily:'Droid' }}>
                        Deconnextion
                    </Text>
