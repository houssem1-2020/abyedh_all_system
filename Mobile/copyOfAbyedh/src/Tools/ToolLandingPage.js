...
import { View, ScrollView,  Text, Image, StyleSheet, FlatList, TouchableOpacity, Dimensions } from 'react-native';
...
const FastSearch = () => {
  ...
  const LinkCard = ({ link, name, img }) => (
    <View style={{ marginBottom: 12, width:'33.33%' , alignItems:'center', justifyContent:'center' }}>
      <View style={{  width:'90%',   borderWidth: 1, borderColor:'#dfdfdf', borderRadius:15,   justifyContent: 'center', alignItems: 'center' }}>
    ...
    <TouchableOpacity  style={{ width: Dimensions.get('window').width / item.width}}  onPress={() => navigation.navigate('MainPage', { Tag: item.tag })}>
      <View style={{ padding: 10, marginBottom: 8, backgroundColor:'#ffffff' ,  margin: 5,   borderRadius: 8,     }}>
        <View style={{ flexDirection: 'column', alignContent:'center' }}>
          <View style={{ marginRight: 10, borderWidth: 1, borderColor:'#dfdfdf', borderRadius:15,   justifyContent: 'center', alignItems: 'center' }}>
