...
const FastSearch = () => {
  ...
  const GoToQrCodeFunction = (value, action) =>{
    const match = value.split("/");
    console.log(match[0])
    console.log(match[1])
    if (action) {
      navigation.navigate('ProfilePage', {Tag: match[0] , PID: match[1], action: true})
    } else {
  ...
  const ActionsBtnCard = (props) => {
    ...
    return (
      ...
      onPress={() => GoToQrCodeFunction(qrCodeValue, true)}
    >
                ...
                <View style={{marginTop : 40}} >
                    {qrCodeValue == null ? (
                        ...
                        <TouchableOpacity
                                ...
                                onPress={() =>  GoToQrCodeFunction(qrCodeValue, false)}
                                disabled={qrCodeValue == null}
                              >
