...
const GConf = {
    ...
    //ApiRouterTwoLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/restaurant-serveur', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    //ApiRouterThreeLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/restaurant-chef', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    DefaultTva: 0,
    themeColor : '#545657',
    ...
    //TableHead
    TableHead:{
        docteurRDV:['*','ID','Client', 'Passé le','Passé le','Volu le','Etat','X','Voir'],
