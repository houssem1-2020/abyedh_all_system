...
function CarParkingSpecific() {
    ...
    const SalleAttentCard = () =>{
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                <h5 className='text-end' style={{color: GConf.ADIL[tag].themeColor}}>  معدل الإكتضاض  </h5> 
    ...
    const RoleTimeEstimateCard = () =>{
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center '>
                <h5 className='text-end ' style={{color: GConf.ADIL[tag].themeColor}}>  حالات الشغور   </h5> 
                <h1 className='display-5 text-warning' dir='rtl'> </h1>
            </div>
        </>)
    }
    const TarifCard = () =>{
    ...
    const CertificatCard = () =>{
        return(<>
            <div className='card card-body shadow-sm border-div mb-4 text-center  '>
                <h5 className='text-end' style={{color: GConf.ADIL[tag].themeColor}}> خريطة الموقع </h5> 
                <h1 className='display-1 text-info'></h1>
            </div>
        </>)
    }
