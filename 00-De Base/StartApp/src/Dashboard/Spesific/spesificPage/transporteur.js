...
function DocteurSpecific() {
   ...
   /*#########################[Function]##################################*/
    ...
    const AssuranceListeCard = (props) =>{
          return(<>
            {returnedProfileData.SP_Camions == '' ? 
            <ListeVide icon='truck' /> 
            :
            <>
              <div style={{maxHeight:'300px', overflowX:'auto', overflowX:'hidden'}}  >
              ...
              <br />
              <Button    fluid className='rounded-pill' size='tiny' color='blue' onClick={() => UpdateFunction('SP_Camions')}>  <Icon name='plus' className='ms-2' /> Modifier </Button>
            </> 
            } 
        </>)
    }
    ...
    const DiplomeListeCard = (props) =>{
        return(<>
          ...
          <>
            ...
            <br />
            <Button    fluid className='rounded-pill' size='tiny' color='blue' onClick={() => UpdateFunction('SP_Trips')}>  <Icon name='plus' className='ms-2' /> Modifier </Button>
          </> 
          } 
      </>)
    }
    ...
    return (<>
          ...
          <br />
          <div className='row mb-3'>
              <div className='col-10 align-self-center'><h4>  Camions  : </h4></div>
