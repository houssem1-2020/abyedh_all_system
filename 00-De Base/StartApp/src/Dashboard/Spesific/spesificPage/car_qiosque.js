...
function DocteurSpecific() {
   ...
   /*#########################[Function]##################################*/
    ...
    const TarifListeCard = (props) =>{
        return(<>
            {returnedProfileData.SP_Tarif_Article == '' ? 
            ...
            <>
              ...
              <br />
              <Button    fluid className='rounded-pill' size='tiny' color='blue' onClick={() => UpdateFunction('SP_Tarif_Article')}>  <Icon name='plus' className='ms-2' /> Modifier </Button>
            </> 
            } 
        </>)
    }
    ...
    const AssuranceListeCard = (props) =>{
          return(<>
            {returnedProfileData.SP_Tarif_Service == '' ? 
            <ListeVide icon='cash-stack' /> 
            :
            <>
              <div style={{maxHeight:'300px', overflowX:'auto', overflowX:'hidden'}}  >
              ...
              <br />
              <Button    fluid className='rounded-pill' size='tiny' color='blue' onClick={() => UpdateFunction('SP_Tarif_Service')}>  <Icon name='plus' className='ms-2' /> Modifier </Button>
            </> 
            } 
        </>)
    }
    ...
    return (<>
          ...
          <div className='row mb-3'>
              <div className='col-10 align-self-center'><h4>Tarif des Carburant: </h4></div>
          ...
          <br />
          <div className='row mb-3'>
              <div className='col-10 align-self-center'><h4>  Tarif des Services  : </h4></div>
