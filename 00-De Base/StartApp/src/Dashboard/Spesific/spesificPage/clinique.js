...
function DocteurSpecific() {
   ...
   /*#########################[Function]##################################*/
    ...
    const DiplomeListeCard = (props) =>{
        return(<>
          {returnedProfileData.SP_Departemment == '' ? 
          ...
          <>
            ...
            <br />
            <Button    fluid className='rounded-pill' size='tiny' color='blue' onClick={() => UpdateFunction('SP_Departemment')}>  <Icon name='plus' className='ms-2' /> Modifier </Button>
          </> 
          } 
      </>)
    }
    ...
    return (<>
          ...
          <br />
          <div className='row mb-3'>
              <div className='col-10 align-self-center'><h4> Assurance  : </h4></div>
          ...
          <br />
          <div className='row mb-3'>
              <div className='col-10 align-self-center'><h4>  Departemment  : </h4></div>
