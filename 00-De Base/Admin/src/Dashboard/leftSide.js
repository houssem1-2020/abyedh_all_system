...
function LeftSideCard() {
    ...
    return (  <>
        ...
        <h1 className='text-white mt-0'><img src={`https://cdn.abyedh.tn/Images/logo/main-lago.gif`} alt="." className="p-0 mt-1 rounded-circle" width="120px" height="120px"/></h1>
            
            <div  className='pt-2' style={{height:'61%', overflowX:'auto', overflowX:'hidden'}}>
