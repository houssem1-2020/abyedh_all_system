...
const MainDataCard = ({factureD, setFactureD,clientList}) =>{
    return (<>
            <div className='card card-body shadow-sm mb-2'>
                ...
                />
                <Input icon='user' type='text' size="small" iconPosition='left'   fluid className='mb-1' value={factureD.Chauffeur} onChange={(e) => setFactureD({...factureD, Chauffeur: e.target.value })}/>
                <div className='row'>
...
function AjouterFacture() {
    ...
    const [factureD, setFactureD] = useState({client:'PASSAGER', de:'Sidi Bourouis', vers:'', Chauffeur:'', jour: Today.toISOString().split('T')[0], totale: 0 , articles:[]})
    ...
    const AddArticles = () =>{
        return (<>
                <div className='card card-body shadow-sm mb-2'>
                    ...
                    <Input icon='pin' list="articlesList" placeholder='Entre aarticle'  onBlur={ (e) => GetArticleData(e.target.value)} size="small" iconPosition='left' placeholder='Desg'  fluid className='mb-1' /> 
