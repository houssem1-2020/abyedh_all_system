...
function SettingPage() {
    ...
    const CalculateResteJour = (date) =>{
        let exDate = new Date(date).toLocaleDateString() 
    ...
    const GeneralSetting = () =>{
        ...
        const NonConirmedCard = () =>{
            return(<>
                <div className="row p-2">
                    <div className="col-12 col-lg-3 align-self-center text-center"><span className='bi bi-shield-fill-exclamation bi-lg text-danger'></span> </div>
                    ...
                    <div className="col-12 col-lg-3 align-self-center text-center">
                        <NavLink exact='true' to='confirmation'>
                            <Button  className='rounded-pill bg-system-btn' size="tiny"  ><Icon name='check' /> Confirmer Ici</Button> 
                        </NavLink>   
                    </div>
                </div>
            </>)
