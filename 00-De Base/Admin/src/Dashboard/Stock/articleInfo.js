   ...
   /*#########################[Card]##################################*/
                ...
                <div className='card card-body shadow-sm mb-2 border-div'>
                    ...
                    <div className="img-card-container text-center">
                        <div className="card-container">
                            <img src={`https://assets.ansl.tn/Images/Articles/${props.data.Photo_Path}`} className="rounded-circle" width="80" />                    
                        </div>
                    </div>
    ...
    const Images = () =>{   
        ...
        <div className='p-2 mb-2'>   
            {articleD.Photo_Path == 'default_img.jpg' ? <UploadImage /> : 'L\'image Deja exist'  } 
        </div>
