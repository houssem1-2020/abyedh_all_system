const GetForTeamM = () =>{
    const admin_subs_L = JSON.parse(localStorage.getItem('Admin_Subs_LocalD'));
    return admin_subs_L
}
...
const InputLinks = {
    ...
    themeColor: '#2f8d99',
    main : [
        {id:1, link:'nv', icon:'person-plus-fill', text:'REQUEST', desc:''},
        {id:2, link:'ed', icon:'patch-check-fill', text:'ACTIVATION', desc:''},
        {id:3, link:'im', icon:'image-fill', text:'IMAGES', desc:''},
        {id:4, link:'pos', icon:'pin-map-fill', text:'POSITION', desc:''},
        {id:5, link:'cl', icon:'cash-stack', text:'PAYMMENT', desc:''},
        {id:6, link:'if', icon:'binoculars-fill', text:'VERIFIER', desc:''},
    ],
    client : [
