    ...
    const MainTopCard = () =>{
        return(<>
             <div className={`card p-3 fixed-top border-0 shadow-sm rounded-0 ${OneGConf.themeMode == 'dark' ? 'bg-dark-theme-1' : '' }`}>
                <div className='row'>
                    <div className='col-9 align-self-center'><h2> <span className="badge bg-info"> <span className='bi bi-pc-display-horizontal '></span>  {OneGConf.forPID.T_Name} </span></h2></div>
                ...
                <Fade >            
                    <div className='container '>
                        <div className='row'>
                            ...
                            <div className='col-12 mb-3'> <LinkCard data={OneGConf.main[2]} /> </div>
