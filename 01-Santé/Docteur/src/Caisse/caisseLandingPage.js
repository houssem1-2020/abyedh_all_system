    ...
    const MainTopCard = () =>{
        return(<>
            <div className='card p-3 fixed-top border-0 shadow-sm rounded-0'>
                <div className='row'>
                    <div className='col-8 align-self-center'><h2> <span className="badge bg-info"> <span className='bi bi-truck '></span>  {camData.Cam_Name} </span></h2></div>
            ...
            <Fade >            
                <div className='container '>
                    <div className='row'>
                        ...
                        <div className='col-4 mb-3'> <LinkCard data={InputLinks.main[2]} /> </div>
                        {/* <div className='col-4 mb-3'> <LinkCard data={InputLinks.main[3]} /> </div> */}
                        <div className='col-4 mb-3'> <LinkCard data={InputLinks.main[4]} /> </div>
                        <div className='col-4 mb-3'> <LinkCard data={InputLinks.main[5]} /> </div>
                    </div>
                </div>
            </Fade> 
