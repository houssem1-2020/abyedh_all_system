...
const EditArticle = ({forfaitD, setFordaitD, OnKeyPressFunc,  EditArticleFunction,loaderState }) =>{
    return(<>
                ...
                <Input icon='star' iconPosition='left' placeholder='Nom' className='w-100 border-0 shadow-sm rounded mb-3' onKeyPress={event => OnKeyPressFunc(event)} value={forfaitD.Tarif_Name}  onChange={(e) => setFordaitD({...forfaitD, Tarif_Name: e.target.value })}/>
                ...
                <div className='row'>
                    <div className='col-12'>
                        ...
                        <Form>
                            <TextArea rows={2} placeholder='Description' onKeyPress={event => OnKeyPressFunc(event)} value={forfaitD.Tarif_Description} onChange={(e) => setFordaitD({...forfaitD, Tarif_Description: e.target.value })}/>
                        </Form>
                    </div>
                </div>
                ...
                <div className='card card-body shadow-sm mb-2 border-div'>
                    ...
                    <div className="img-card-container text-center">
                        <div className="card-container notification bg-white">
                            <img src={`https://cdn.abyedh.tn/images/system/docteur/tarif.png`} className="rounded-circle" width="70px" height="70px" />                    
                        </div>
                    </div>
