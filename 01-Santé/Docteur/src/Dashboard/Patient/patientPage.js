...
function ClientPage() {
    ...
    useEffect(() => {
        ...
        .then(function (response) {
            ...
            getData.Adress,
            _(<Button className='rounded-pill bg-system-btn' size='mini' onClick={ (e) => NavigateFunction(`/S/pt/info/${getData.PA_ID}`)}><span className='d-none d-lg-inline'> Info </span><Icon  name='angle right' /></Button>)
            ],))
