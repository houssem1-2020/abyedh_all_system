    ...
    const LeftCard = (props) =>{
        return(
            ...
            <div className='col-12 col-lg-4  text-center d-none d-lg-block fixed-top ' style={{backgroundColor:props.color, height:'100vh' }}>
                ...
                <h1  style={{marginTop:'1%'}} className='text-white'><img src="https://cdn.abyedh.tn/images/ads/avocat.svg" alt="." className="p-0" width="300px" height="300px"/></h1>
        ...
        <div className='row m-0'>
            ...
            <div className='col-12 col-lg-7 '>
                ...
                <Bounce left>
                            ...
                            <SubSystemLink title="Rendy-Vous" text="Interface Pour Les RDV" icon="pc-display-horizontal" link="/C"/>
                            <br />
