...
const GConf = {
    ...
    //Subsystems
    SubSystemLink : [
        {id: 1, title:'Nouveaux Abonnement', text:'Interface Pour Ajouter Membre', icon:'pc-display-horizontal', link:'/R'},
        {id: 3, title:'Presence', text:'Interface Pour Enregistrer Le Presnce', icon:'pc-display', link:'/C'},
    ],
    ...
    NavsData : [
            ...
            {id:4, name:"Abonnement", icon:"receipt-cutoff", link:"ft"},
            {id:5, name:"Instrument", icon:"pc-display-horizontal", link:"ca"},
            // {id:6, name:"Calendrier", icon:"upc-scan", link:"sk"},
