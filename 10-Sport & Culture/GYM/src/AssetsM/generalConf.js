...
const GConf = {
    ...
    // main variables
    PID: GetPID(),
    ApiLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/gym', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    ApiRouterOneLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/gym-caisse', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    ApiRouterTwoLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/gym-serveur', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    ApiRouterThreeLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/gym-chef', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    DefaultTva: 0,
    themeColor : '#7aadab',
    ...
    NavsData : [
            ...
            {id:3, name:"Membre", icon:"people", link:"mb"},
