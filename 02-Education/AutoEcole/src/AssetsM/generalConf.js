...
const GConf = {
    ...
    // main variables
    PID: GetPID(),
    ApiLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/autoecole', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    ApiRouterOneLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/autoecole-caisse', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    ApiRouterTwoLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/autoecole-serveur', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    ApiRouterThreeLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/autoecole-chef', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    DefaultTva: 0,
    themeColor : '#1caaa8',
    ...
    //Subsystems
    SubSystemLink : [
        {id: 3, title:'Prof', text:'Interface Pour La Caisse', icon:'pc-display', link:'/C'},
    ...
    TableHead:{
        ...
        reservation:['*','ID','Client', 'Passé le','Volu le','Etat','Etat','X','Voir'],
