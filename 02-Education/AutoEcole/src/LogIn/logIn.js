    ...
    const LeftCard = (props) =>{
        return(
            ...
            <div className='col-12 col-lg-4  text-center d-none d-lg-block fixed-top ' style={{backgroundColor:props.color, height:'100vh' }}>
                ...
                <h1  style={{marginTop:'1%'}} className='text-white'><img src={`https://cdn.abyedh.tn/images/ads/${GConf.systemTag}.svg`} alt="." className="p-0" width="300px" height="300px"/></h1>
            </div>
            </>
        )
    }
                        ...
                        <Grid.Column className="align-self-center" mobile={12} tablet={12} computer={13}>
                            <div className="d-flex align-self-center " style={{color: GConf.themeColor}}>
                                ...
                                <div className="flex-grow-1 ms-3">
                                    ...
                                    <small className='text-secondary'> {props.data.text} </small>
                                </div>
                            </div>
                        </Grid.Column>
        ...
        <div className='row m-0'>
            ...
            <div className='col-12 col-md-10 col-lg-7'>
                ...
                <Bounce left>
                            ...
                            {GConf.SubSystemLink.map((data,index) => <SubSystemLink key={index} data={data} />)}
                    </Bounce>
                </div>
            </div>
        </div> 
