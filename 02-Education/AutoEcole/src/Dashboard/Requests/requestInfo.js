...
function RequestInfo() {
                ...
                <div className='card card-body shadow-sm mb-2 border-div'>
                    ...
                    <div className='row '>
                        <div className='col-6 mb-2'>
                            <Button disabled={FindBtnState(reqState).redirectState} className='rounded-pill bg-danger text-white'  fluid onClick={ () => openEditModal('R')}><Icon name='trash' /> Annulée</Button>
                        </div>
                        <div className='col-6 mb-2'>
                            <Button disabled={FindBtnState(reqState).redirectState} className='rounded-pill bg-success text-white'  fluid onClick={ () => openEditModal('A')}><Icon name='check' /> Accepteé</Button>
                        </div>
                        <div className='col-6 mb-2'>
                            <Button disabled={FindBtnState(reqState).redirectState} className='rounded-pill bg-retarder text-white'  fluid onClick={ () => openEditModal('RT')}><Icon name='delete calendar' /> Retardeé</Button>
                        </div>
                        <div className='col-6 mb-2'>
                            <Button disabled={FindBtnState(reqState).redirectState} className='rounded-pill bg-rederecter text-white'  fluid onClick={ () => openEditModal('RD')}><Icon name='refresh' /> Redirecteé</Button>
                        </div>
                        ...
                        <div className='col-12 mb-2'>
                            <Button as='a' onClick={ (e) => navigate(`/S/sa/ajouter?CID=${CID}`)} animated disabled={FindBtnState(reqState).redirectState} className='rounded-pill bg-system-btn'  fluid>
                                <Button.Content visible><Icon name='calendar check' /> Enregistreé Seance </Button.Content>
                        ...
                        <div className='col-12 mb-2'>
                            <Button disabled={FindBtnState(reqState).redirectState} className='rounded-pill bg-secondary text-white'  fluid onClick={ () => UpdateRequestState('T',false,false,true,'terminer')}><Icon name='refresh' /> Terminer</Button>
                        </div>
                        <div className='col-12 mb-2'>
                            <Button disabled={FindBtnState(reqState).redirectState} className='rounded-pill bg-info text-white'  fluid onClick={ () => UpdateRequestState('W',false,false,false,false)}><Icon name='eye' /> marquer comme non Vu</Button>
                        </div>
                    </div>
        ...
        return(<>
                <div className='card card-body shadow-sm mb-2 mt-3 border-div'>
                    <div className='row mb-3'>
                        ...
                        <div className='col-6 text-end'>{requestData.Releted_UID ? <span className='badge bg-success p-2'>Déja Enregistreé</span> : <span className='badge bg-danger badge-lg'>Nouveaux Patient</span>}</div>
                    </div>
                    <div className='row mb-2'>
                        <div className='col-12 col-lg-6'> Nom : {loading ? requestData.Name : ''} </div> 
                        <div className='col-12 col-lg-6'> Phone : {loading ? requestData.PhoneNum : ''} </div> 
                        <div className='col-12 col-lg-6'> Gouv : {loading ? requestData.BirthGouv : ''} </div> 
                        <div className='col-12 col-lg-6'> Deleg : {loading ? requestData.BirthDeleg : ''} </div> 
                    </div> 
    ...
    const AddUserCard = () =>{
        return(<>
                <Divider />
                <h5>Voulez Vous Enregistrer ce Patient ?</h5>
                <div className='row mb-2'>
                    <div className='col-6'>
                            ...
                            <div className='col-12 mb-3'> Nom :  {loading ? requestData.Name : ''}
                            ...
                            <div className='col-12 mb-3'> Phone : {loading ? requestData.PhoneNum : ''}
                    ...
                    <div className='col-6'>
                        <div className='col-12 mb-3'> Gouv : {loading ? requestData.BirthGouv : ''} 
                        ...
                        <div className='col-12 mb-3'> Deleg : {loading ? requestData.BirthGouv : ''}
                        ...
                        <div className='col-12 mb-3'>
                            Deleg : {loading ? requestData.BirthGouv : ''}
                            <Form>
                ...
                <div className='text-end'>
                    <Button  className='rounded-pill text-secondary btn-imprimer' size='mini' disabled={requestData.Releted_UID}   onClick={(e) => SaveClientFunction()}><Icon name='edit outline' /> Enregistrer Client</Button>
                </div>  
        </>)
    }
