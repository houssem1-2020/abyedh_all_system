                ...
                <div className='card card-body    border-div'>
                        <table className='table mt-2 table-striped table-bordered border-div'>
                            <tbody>
                                ...
                                <tr>
                                    <td><span className='bi bi-chat-dots-fill'></span> Condidat :</td>
    ...
    const BtnsCard = () =>{
        return(<>
                <div className='card card-body shadow-sm mb-2 border-div'>
                    ...
                    <div className='col-6'>
                            <Button as='a' onClick={ (e) => NavigateFunction(`/S/sa/modifier/${SID}`)}  animated   className='rounded-pill bg-system-btn'  fluid>
