...
const TerminerCard = ({seanceData, setSeanceData,offresListe , voitureListe, moniteurListe, OnKeyPressFunc}) =>{
    ...
    return (<>
                ...
                <Input icon='add user' onKeyPress={event => OnKeyPressFunc(event)} list="abonnemmentListe" placeholder={seanceData.SE_Abonnemment}   onBlur={ (e) => setSeanceData({...seanceData, SE_Abonnemment: e.target.value }) } size="small" iconPosition='left'   fluid className='mb-1' />
                ...
                <Input icon='car' onKeyPress={event => OnKeyPressFunc(event)} list="voitureListe" placeholder={seanceData.Voiture_ID}   onBlur={ (e) => setSeanceData({...seanceData, Voiture_ID: e.target.value }) } size="small" iconPosition='left'   fluid className='mb-1' />
                ...
                <Input icon='group' onKeyPress={event => OnKeyPressFunc(event)} list="moniteurListe" placeholder={seanceData.Moniteur_ID}   onBlur={ (e) => setSeanceData({...seanceData, Moniteur_ID: e.target.value }) } size="small" iconPosition='left'   fluid className='mb-1' />
    </>)
}
...
function EditFacture() {
    ...
    const panes = [
        ...
        {
            menuItem: { key: 'start', icon: 'add circle', content: 'Remarque ' }, 
