    ...
    return (<>
              <div className='row'>
                  ...
                  <div className='col-12 col-lg-4 text-end align-self-center'>
                      <MainSubNavCard text='Emploi' link='em' icon='box-seam-fill' />
                      <MainSubNavCard text='Examain' link='ex' icon='box-seam-fill' />
              ...
              <Modal
                  ...
                  >
                              ...
                              <div className='row'>
                                  ...
                                  <div className='col-8 align-self-center'>
                                        ...
                                        <tbody>
                                              <tr>
                                                 <td>Code : </td> 
                                                 <td>{selectedArticle.INS_Code}</td> 
                                              </tr>
                                              <tr>
                                                 <td>Cout : </td> 
                      ...
                      <Modal.Actions>
                                  ...
                                  <Button className='rounded-pill bg-system-btn'   onClick={ (e) => NavigateFunction(`/S/eq/info/${selectedArticle.INS_Code}`)}><span className='d-none d-lg-inline'> Info </span><Icon  name='angle right' /></Button>
                      </Modal.Actions>
              </Modal>  
              </Transition>
        </>);
