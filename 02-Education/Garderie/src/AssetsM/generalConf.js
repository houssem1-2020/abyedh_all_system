...
const GConf = {
    ...
    //Subsystems
    SubSystemLink : [
        {id: 1, title:'Presence', text:'Interface Pour Enregistrer Le Presence', icon:'pc-display-horizontal', link:'/R'},
        {id: 3, title:'Maitre', text:'Interface Pour Les Maitres', icon:'pc-display', link:'/C'},
    ],
    ...
    NavsData : [
            ...
            {id:3, name:"Eleve", icon:"people", link:"cl"},
            {id:4, name:"Abonnement", icon:"receipt-cutoff", link:"ft"},
            {id:5, name:"Classes", icon:"pc-display-horizontal", link:"ca"},
