...
const GConf = {
    ...
    //main stat card
    LinkCard: [
        { id: 1, col: 2 , tag:"article", dataTag:'seancesNum',  icon: 'upc-scan', link:'sa/ajouter-c', smallT: 'Seance', desc: 'Nouveaux  ', isFloat : false , stat:'22452'},
        { id: 2, col: 2 , tag:"facture", dataTag:'abonnementNum', icon: 'receipt-cutoff', link:'ab/ajouter', smallT: 'Abonnemment', desc: 'Ajouiter', isFloat : false , stat:'22452'},
        { id: 3, col: 2 , tag:"client", dataTag:'elevesNum', icon: 'person', link:'el/ajouter', smallT: 'Eleve', desc: 'Ajouter', isFloat : false , stat:'1235'},
        { id: 4, col: 2 , tag:"caisse", dataTag:'classesNum', icon: 'pc-display-horizontal', link:'cl/ajouter', smallT: 'Classes', desc: 'Inventaire', isFloat : false , stat:'22'},
    ...
    SubNavs: {
        ...
        client: [
            ...
            {id:2,  icon: 'balloon-heart', text: 'Presence', link: 'presence', dropD: false},
    ...
    TableHead:{
        ...
        eleve:['*','Nom','Genre', 'Classe', 'Adresse','Pere','Mere','Voir'],
