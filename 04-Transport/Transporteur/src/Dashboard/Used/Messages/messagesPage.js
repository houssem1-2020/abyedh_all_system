    ...
    return (<>
            ...
            <div className="row p-0">
                ...
                <div className="col-12 col-lg-8 text-center">
                    <img src='https://cdn.abyedh.tn/Images/system/no-message.svg' className='img-responsive' width='80%'  height='250px' />
                    <h3 className='text-center'>Vous n'avez pas de messages </h3>
