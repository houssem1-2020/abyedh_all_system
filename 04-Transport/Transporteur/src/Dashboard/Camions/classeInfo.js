...
function PlatInfo() {
   ...
   /*#########################[UseEffect]##################################*/
    ...
    const EditIngredientFunction = (event) => {
        setLS(true)
        axios.post(`${GConf.ApiLink}/camion/modifier/ingredient`, {
            PID :GConf.PID,
            CodePlat : code,
                ...
                <div className='card card-body shadow-sm mb-2 border-div'>
                    ...
                    <div className="img-card-container text-center">
                        <div className="card-container notification">
                            <img src={`https://cdn.abyedh.tn/images/system/autoecole/voitures.png`} className="rounded-circle bg-white" width="80px" height="80px" />                    
                        </div>
                    </div>
