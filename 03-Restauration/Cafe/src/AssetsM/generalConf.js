...
const GConf = {
    ...
    // main variables
    PID: GetPID(),
    ApiLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/cafe', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    ApiRouterOneLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/cafe-caisse', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    ApiRouterTwoLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/cafe-serveur', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    ApiRouterThreeLink : 'https://api.system.abyedh.tn/apiSystemAbyedh/cafe-chef', //https://api.system.abyedh.tn/apiSystemAbyedh/System 
    DefaultTva: 0,
    themeColor : '#363636',
    ...
    NavsData : [
            ...
            // {id:3, name:"Boissones", icon:"people", link:"cl"},
    ...
    LinkCard: [
        ...
        { id: 1, col: 2 , tag:"article", dataTag:'articlesNum',  icon: 'upc-scan', link:'mu/ajouter', smallT: 'Boisson', desc: 'Nouveaux  ', isFloat : false , stat:'22452'},
    ...
    BreadCrumb:{
        menuAddPlat: [
            ...
            {id:2, name:'Ajouter Boisson', linkable:false}
        ],
        menuFamille: [
            {id:1, name:'Menu', linkable:true, link:"/S/mu"},
    ...
    SubNavs: {
        ...
        Menu: [
            {id:1,  icon: 'bookmark-plus', text: 'Nouveaux Boisson', link: 'ajouter', dropD: false},
            {id:2, icon: 'tags', text: 'Famille des Boissons', link: 'famille', dropD: false },
    ...
    Setting: [
        ...
        { id: '4', title: "Menu", image: "14", description: "Boissons, Familles , Articels", link:"p/Menu",
            items:[
                {id: 1, genre:'C', title:"Ajouter des nouveaux Boissons ", icon:"upc-scan", text:"Autoriseé l'ajout des nouveaux articles", state:'checked'},
