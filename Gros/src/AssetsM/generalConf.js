...
const GConf = {
    ...
    // main variables
    PID: GetPID(),
    ApiLink : 'http://localhost:3010/ptvg', //https://api.system.abyedh.tn/apiSystemAbyedh 
    ApiCommandeLink : 'http://localhost:3010/ptvgi', //https://api.system.abyedh.tn/apiSystemAbyedh 
    ApiCamionLink : 'http://localhost:3010/ptvgi', //https://api.system.abyedh.tn/apiSystemAbyedh 
    DefaultTva: 0,
    themeColor : '#6f858f',
    ...
    Setting: [
        ...
        { id: '6', title: "Camions", image: "09", description: "Etat de cabinet, camera, laboratoire ...", link:"p/Camions",
            items:[
